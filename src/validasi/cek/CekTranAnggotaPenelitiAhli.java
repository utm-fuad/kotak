 ...
 * @author faheem
 */
public class CekTranAnggotaPenelitiAhli {
    
    private Function fn = new Function();

    public String cekKolom(int baris, String sKolom, Object value) {
        String message = "";
        if (sKolom.equalsIgnoreCase("Kode_anggota_peneliti_ahli") && (value == null || value.toString().equalsIgnoreCase(""))) {
        ...
        if (sKolom.equalsIgnoreCase("Kode_tenaga_ahli") && (value == null || value.toString().equalsIgnoreCase(""))) {
            message = "Baris ke : " + baris + " Kolom " + sKolom + " Wajib diisi!";
            return message;
        }
//        Nomor_SK_BN TEXT
