 ...
 * @author asus
 */
public class ReferensiMenu extends javax.swing.JPanel {
    ...
    private JTextField flagmenu;  
    private koneksi.KompletTextFieldCombo kompletTextFieldCombo1;
    
    private int kodemenu, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiMenu() {    
        initComponents();
    }
    
    public ReferensiMenu(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initAutoComplete() {                
        kompletTextFieldCombo1 = new KompletTextFieldCombo(kon, 
                flagmenuField, flagmenu);        
        String [][] datanya1 = {{"1", "Ditampilkan"},
            {"2","Hidden atau tidak ditampilkan"}}; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(datanya1);
        flagmenu = kompletTextFieldCombo1.dapatkanTextField();
        flagmenuField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_menu " +
                " from TREF_MENU " +
                " order by Kode_menu desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodemenu = Integer.parseInt(data[0][0]);
        kodemenu++;
        System.out.println("kodemenu: " + kodemenu);
    }
    ...
    public ReferensiMenu(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        ...
        urlField.setText("");
        levelmenuField.setText("");
        rootmenuField.setText("");
        deskripsiField.setText("");        
        urutanmenuField.setText("");
        flagmenu.setText("");
        menuiconField.setText("");
    ...
    private void tampilkanData(int row) {
        ...
        kodemenuField.setText(tabel.getValueAt(row, 0).toString());
        namamenuField.setText(tabel.getValueAt(row, 1).toString());
        urlField.setText(tabel.getValueAt(row, 2).toString());
        levelmenuField.setText(tabel.getValueAt(row, 3).toString());
        rootmenuField.setText(tabel.getValueAt(row, 4).toString());
        deskripsiField.setText(tabel.getValueAt(row, 5).toString());
        urutanmenuField.setText(tabel.getValueAt(row, 6).toString());
        flagmenu.setText(tabel.getValueAt(row, 7).toString());
        menuiconField.setText(tabel.getValueAt(row, 8).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodemenuField.getText().equals("")?kodemenuField.getText():"0");
        data[1] = (!namamenuField.getText().equals("")?namamenuField.getText():"X");
        data[2] = (!urlField.getText().equals("")?urlField.getText():"X");
        data[3] = (!levelmenuField.getText().equals("")?levelmenuField.getText():"0");
        data[4] = (!rootmenuField.getText().equals("")?rootmenuField.getText():"0");
        data[5] = (!deskripsiField.getText().equals("")?deskripsiField.getText():"X");
        data[6] = (!urutanmenuField.getText().equals("")?urutanmenuField.getText():"0");
        String dataflagmenumentah = flagmenu.getText();
        System.out.println("data flagmenu mentah: " + dataflagmenumentah);
        String [] dataflagmenu = dataflagmenumentah.split(" ");
        System.out.println("data flagmenu yg dipilih: " + dataflagmenu[0]);
        data[7] = dataflagmenu[0];
        data[8] = (!menuiconField.getText().equals("")?menuiconField.getText():"X");
        data[9] = "" + idlogaudit;
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                        
        data[0] = (!namamenuField.getText().equals("")?namamenuField.getText():"X");
        data[1] = (!urlField.getText().equals("")?urlField.getText():"X");
        data[2] = (!levelmenuField.getText().equals("")?levelmenuField.getText():"0");
        data[3] = (!rootmenuField.getText().equals("")?rootmenuField.getText():"0");
        data[4] = (!deskripsiField.getText().equals("")?deskripsiField.getText():"X");
        data[5] = (!urutanmenuField.getText().equals("")?urutanmenuField.getText():"0");
        String dataflagmenumentah = flagmenu.getText();
        System.out.println("data flagmenu mentah: " + dataflagmenumentah);
        String [] dataflagmenu = dataflagmenumentah.split(" ");
        System.out.println("data flagmenu yg dipilih: " + dataflagmenu[0]);
        data[6] = dataflagmenu[0];
        data[7] = (!menuiconField.getText().equals("")?menuiconField.getText():"X");
        data[8] = "" + idlogaudit;
        data[9] = (!kodemenuField.getText().equals("")?kodemenuField.getText():"0");
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodemenuField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodemenuLabel = new javax.swing.JLabel();
        namamenuLabel = new javax.swing.JLabel();
        urlLabel = new javax.swing.JLabel();
        levelmenuLabel = new javax.swing.JLabel();
        rootmenuLabel = new javax.swing.JLabel();
        deskripsiLabel = new javax.swing.JLabel();
        urutanmenuLabel = new javax.swing.JLabel();
        flagmenuLabel = new javax.swing.JLabel();
        menuiconLabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        kodemenuField = new javax.swing.JFormattedTextField();
        namamenuField = new javax.swing.JTextField();
        urlField = new javax.swing.JTextField();
        levelmenuField = new javax.swing.JFormattedTextField();
        rootmenuField = new javax.swing.JFormattedTextField();
        deskripsiField = new javax.swing.JTextField();
        urutanmenuField = new javax.swing.JFormattedTextField();
        flagmenuField = new javax.swing.JComboBox();
        menuiconField = new javax.swing.JTextField();
        ...
        kodemenuLabel.setText("Kode Menu:");
        panelLabel.add(kodemenuLabel);

        namamenuLabel.setText("Nama Menu:");
        panelLabel.add(namamenuLabel);

        urlLabel.setText("URL:");
        panelLabel.add(urlLabel);

        levelmenuLabel.setText("Level Menu:");
        panelLabel.add(levelmenuLabel);

        rootmenuLabel.setText("Root Menu:");
        panelLabel.add(rootmenuLabel);

        deskripsiLabel.setText("Deskripsi:");
        panelLabel.add(deskripsiLabel);

        urutanmenuLabel.setText("Urutan Menu:");
        panelLabel.add(urutanmenuLabel);

        flagmenuLabel.setText("Flag Menu:");
        panelLabel.add(flagmenuLabel);

        menuiconLabel.setText("Menu Icon:");
        panelLabel.add(menuiconLabel);
        ...
        kodemenuField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(kodemenuField);
        panelTextField.add(namamenuField);
        panelTextField.add(urlField);

        levelmenuField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(levelmenuField);

        rootmenuField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(rootmenuField);
        panelTextField.add(deskripsiField);

        urutanmenuField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(urutanmenuField);

        panelTextField.add(flagmenuField);
        panelTextField.add(menuiconField);
    ...
    private javax.swing.JComboBox flagmenuField;
    private javax.swing.JLabel flagmenuLabel;
    private javax.swing.JScrollPane gulungPanelAtribut;
    private javax.swing.JScrollPane gulungTabel;
    private javax.swing.JSplitPane jSplitPane1;
    private javax.swing.JSplitPane jSplitPane2;
    private javax.swing.JFormattedTextField kodemenuField;
    private javax.swing.JLabel kodemenuLabel;
    private javax.swing.JFormattedTextField levelmenuField;
    private javax.swing.JLabel levelmenuLabel;
    private javax.swing.JTextField menuiconField;
    ...
    private javax.swing.JFormattedTextField rootmenuField;
    private javax.swing.JLabel rootmenuLabel;
    private javax.swing.JTable tabel;
    private javax.swing.JTextField urlField;
    private javax.swing.JLabel urlLabel;
    private javax.swing.JFormattedTextField urutanmenuField;
    private javax.swing.JLabel urutanmenuLabel;
