 ...
 * @author asus
 */
public class MasterFotoPT extends javax.swing.JPanel {
    ...
    public MasterFotoPT(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelFotoPT();
        kodept = homePage.dapatkanKodePT();
        inisialisasiData();
        KodePTField.setText(kodept);
//        initAutoComplete();
         //disable all button
...
//        kodejenjangpendidikanField = kompletTextFieldCombo2.dapatkanComboBox();
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TMST_FOTO_PERGURUAN_TINGGI\"";
    ...
    public MasterFotoPT(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        IDField.setText(tabel.getValueAt(row, 0).toString());
        KodePTField.setText(tabel.getValueAt(row, 1).toString());
        FileFotoField.setText(tabel.getValueAt(row, 2).toString());
        CaptionField.setText(tabel.getValueAt(row, 3).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
       ...
       data[1] = KodePTField.getText();
       data[2] = FileFotoField.getText();
       data[3] = CaptionField.getText();
      kalendar = tgluploadField.getCalendar();
...
//        String data7 = hari + " " + bulan + " " + tahun;
        ...
        System.out.println("date "+data2);
        data[2] = (data2!=null?data2:"");
        data[3] = DipakaiField.getText();
        data[4] = KodePTField.getText();
        data[5] = IDField.getText();
        return data;
    }
    ...
    private void initComponents() {
        ...
        kodeperguruantinggiLabel1 = new javax.swing.JLabel();
        kodeperguruantinggiLabel2 = new javax.swing.JLabel();
        ...
        CaptionField = new javax.swing.JFormattedTextField();
        tgluploadField = new com.toedter.calendar.JDateChooser();
        ...
        kodepustakaptLabel.setText("ID:");
        panelLabel.add(kodepustakaptLabel);

        tahunpelaporanLabel.setText("Kode Perguruan Tinggi:");
        panelLabel.add(tahunpelaporanLabel);

        semesterpelapporanLabel.setText("File Foto :");
        panelLabel.add(semesterpelapporanLabel);

        kodeperguruantinggiLabel.setText("Caption:");
        panelLabel.add(kodeperguruantinggiLabel);

        kodeperguruantinggiLabel1.setText("Tanggal Upload :");
        panelLabel.add(kodeperguruantinggiLabel1);

        kodeperguruantinggiLabel2.setText("Dipakai:");
        panelLabel.add(kodeperguruantinggiLabel2);
        ...
        panelTextField.add(IDField);

        try {
            KodePTField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("####")));
        ...
        try {
            CaptionField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("######")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        panelTextField.add(CaptionField);
        panelTextField.add(tgluploadField);
...
//            dapatkanNilaiUntukInsert() );
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        "\"Tanggal_Upload\"=?, "+
        "\"Dipakai\"=? "+
        " WHERE \"Kode_Perguruan_Tinggi\"=? and \"ID\"=?";
//        int hasil = kon.insertUpdateDeleteData(query,
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JFormattedTextField CaptionField;
    ...
    private javax.swing.JLabel kodeperguruantinggiLabel1;
    private javax.swing.JLabel kodeperguruantinggiLabel2;
    ...
    private com.toedter.calendar.JDateChooser tgluploadField;
