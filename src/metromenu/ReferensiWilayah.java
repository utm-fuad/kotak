 ...
 * @author asus
 */
public class ReferensiWilayah extends javax.swing.JPanel {
     ...
     */
    public ReferensiWilayah() {    
        initComponents();
    }
    
    public ReferensiWilayah(HomePage _homePage, String _namaTabel) {
        this();
    ...
    public ReferensiWilayah(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodewilayahField.setText(tabel.getValueAt(row, 0).toString());
        namawilayahField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodewilayahField.getText().equals("")?kodewilayahField.getText():"0");
        data[1] = (!namawilayahField.getText().equals("")?namawilayahField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namawilayahField.getText();                
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodewilayahField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodewilayahField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namawilayahLabel = new javax.swing.JLabel();
        ...
        kodewilayahField = new javax.swing.JFormattedTextField();
        namawilayahField = new javax.swing.JTextField();
        ...
        namawilayahLabel.setText("Nama Wilayah:");
        panelLabel.add(namawilayahLabel);
        ...
        kodewilayahField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(kodewilayahField);
        panelTextField.add(namawilayahField);
    ...
    private javax.swing.JFormattedTextField kodewilayahField;
    private javax.swing.JLabel kodewilayahLabel;
    private javax.swing.JTextField namawilayahField;
    private javax.swing.JLabel namawilayahLabel;
