 ...
 * @author asus
 */
public class ValidasiPT extends javax.swing.JPanel {
    ...
    private JTextField flagvalidasi;  
    private koneksi.KompletTextFieldCombo kompletTextFieldCombo;
    
    private int kodevalidasitotalpt, idlogaudit;
    ...
    public ValidasiPT(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_validasi_total_pt " +
                " from pdpt_dev.TRAN_VALIDASI_PT " +
                " order by Kode_validasi_total_pt desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        if (data[0][0] == null) {
            kodevalidasitotalpt = 1;
        } else {
            kodevalidasitotalpt = Integer.parseInt(data[0][0]);
            kodevalidasitotalpt++;            
        }
        System.out.println("kodevalidasitotalpt: " + kodevalidasitotalpt);
    }
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_VALIDASI_PT\"";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by Kode_validasi_total_pt desc";
        kon.selectData(query);     
    ...
    public ValidasiPT(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void initAutoComplete() {        
        kompletTextFieldCombo = new KompletTextFieldCombo(kon, 
                flagvalidasiField, flagvalidasi);        
        String [][] datanya = {{"1", "Fakultas"},
            {"2","Jurusan"},{"3", "Program Studi"},
            {"4","Dosen"},{"5","Mahasiswa"}}; 
        kompletTextFieldCombo.initDataUtkAutoComplete(datanya);        
        flagvalidasi = kompletTextFieldCombo.dapatkanTextField();
        flagvalidasiField = kompletTextFieldCombo.dapatkanComboBox();
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodevalidasitotalptField.setText("" + kodevalidasitotalpt);
        ...
        flagvalidasi.setText("");
        jumlahtotalvalidasiptField.setText("");
    ...
    private void tampilkanData(int row) {
        ...
        kodevalidasitotalptField.setText(tabel.getValueAt(row, 0).toString());
        ...
        flagvalidasi.setText(tabel.getValueAt(row, 4).toString());
        jumlahtotalvalidasiptField.setText(tabel.getValueAt(row, 5).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodevalidasitotalptField.getText().equals("")?kodevalidasitotalptField.getText():"0");
        data[2] = (!tahunpelaporanField.getText().equals("    ")?tahunpelaporanField.getText():"0");
        data[3] = (!semesterpelaporanField.getText().equals(" ")?semesterpelaporanField.getText():"0");
        
        String dataflagvalidasimentah = flagvalidasi.getText();
        System.out.println("data flag validasi mentah: " + dataflagvalidasimentah);
        String [] dataflagvalidasi = dataflagvalidasimentah.split(" ");
        System.out.println("data flag validasi yg dipilih: " + dataflagvalidasi[0]);
        data[4] = dataflagvalidasi[0];
        
        data[5] = (!jumlahtotalvalidasiptField.getText().equals("")?jumlahtotalvalidasiptField.getText():"0");
        data[6] = "" + idlogaudit;
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        String [] dataflagvalidasi = dataflagvalidasimentah.split(" ");
        System.out.println("data flag validasi yg dipilih: " + dataflagvalidasi[0]);
        data[3] = dataflagvalidasi[0];
        
        data[4] = (!jumlahtotalvalidasiptField.getText().equals("")?jumlahtotalvalidasiptField.getText():"0");
        data[5] = "" + idlogaudit;
        data[6] = (!kodevalidasitotalptField.getText().equals("")?kodevalidasitotalptField.getText():"0");
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodevalidasitotalptField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodevalidasitotalptLabel = new javax.swing.JLabel();
        ...
        flagvalidasiLabel = new javax.swing.JLabel();
        jumlahtotalvalidasiptLabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        kodevalidasitotalptField = new javax.swing.JFormattedTextField();
        ...
        flagvalidasiField = new javax.swing.JComboBox();
        jumlahtotalvalidasiptField = new javax.swing.JFormattedTextField();
        ...
        kodevalidasitotalptLabel.setText("Kode Validasi Total PT:");
        panelLabel.add(kodevalidasitotalptLabel);
        ...
        flagvalidasiLabel.setText("Flag Validasi:");
        panelLabel.add(flagvalidasiLabel);

        jumlahtotalvalidasiptLabel.setText("Jumlah Total Validasi PT:");
        panelLabel.add(jumlahtotalvalidasiptLabel);
        ...
        kodevalidasitotalptField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodevalidasitotalptField);
        ...
        panelTextField.add(flagvalidasiField);

        jumlahtotalvalidasiptField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(jumlahtotalvalidasiptField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        "Semester_pelaporan=?, " +
        "Flag_validasi=?, " +
        "Jumlah_total_validasi_pt=?, " +
        "ID_log_audit=? " +
        " WHERE Kode_validasi_total_pt=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JComboBox flagvalidasiField;
    private javax.swing.JLabel flagvalidasiLabel;
    private javax.swing.JScrollPane gulungPanelAtribut;
    private javax.swing.JScrollPane gulungTabel;
    private javax.swing.JSplitPane jSplitPane1;
    private javax.swing.JSplitPane jSplitPane2;
    private javax.swing.JFormattedTextField jumlahtotalvalidasiptField;
    private javax.swing.JLabel jumlahtotalvalidasiptLabel;
    private javax.swing.JFormattedTextField kodeperguruantinggiField;
    private javax.swing.JLabel kodeperguruantinggiLabel;
    private javax.swing.JFormattedTextField kodevalidasitotalptField;
    private javax.swing.JLabel kodevalidasitotalptLabel;
