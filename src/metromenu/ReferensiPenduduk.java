 ...
 * @author asus
 */
public class ReferensiPenduduk extends javax.swing.JPanel {
    ...
    private int kodependuduk, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiPenduduk() {    
        initComponents();
    }
    
    public ReferensiPenduduk(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initAutoComplete() {        
        ...
        String [][] datanya2 = {{"L", "Laki-laki"},
            {"P","Perempuan"}}; 
        kompletTextFieldCombo2.initDataUtkAutoComplete(datanya2);
        jeniskelamin = kompletTextFieldCombo2.dapatkanTextField();
        jeniskelaminField = kompletTextFieldCombo2.dapatkanComboBox();
    }
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_penduduk " +
                " from TREF_PENDUDUK " +
                " order by Kode_penduduk desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodependuduk = Integer.parseInt(data[0][0]);
        kodependuduk++;
        System.out.println("kodependuduk: " + kodependuduk);
    }
    ...
    public ReferensiPenduduk(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodependudukField.setText(tabel.getValueAt(row, 0).toString());
        jumlahpendudukField.setText(tabel.getValueAt(row, 1).toString());
        tahunField.setText(tabel.getValueAt(row, 2).toString());
        kategoripendudukField.setText(tabel.getValueAt(row, 3).toString());
        nilaikategoripendudukField.setText(tabel.getValueAt(row, 4).toString());
        kodeprovinsi.setText(tabel.getValueAt(row, 5).toString());
        jeniskelamin.setText(tabel.getValueAt(row, 6).toString());
        referensiField.setText(tabel.getValueAt(row, 7).toString());
        ...
        //IDlogauditField.setText(tabel.getValueAt(row, 10).toString());
    }
    
    public String [] dapatkanNilaiUntukInsert() {
        String [] data = new String[jmlKolom];
        data[0] = (!kodependudukField.getText().equals("")?kodependudukField.getText():"0");
        data[1] = (!jumlahpendudukField.getText().equals("")?jumlahpendudukField.getText():"0");
        data[2] = (!tahunField.getText().equals("    ")?tahunField.getText():"0000");
        data[3] = (!kategoripendudukField.getText().equals("")?kategoripendudukField.getText():"X");
        data[4] = (!nilaikategoripendudukField.getText().equals("")?nilaikategoripendudukField.getText():"X");
        ...
        data[7] = (!referensiField.getText().equals("")?referensiField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = jumlahpendudukField.getText();                
        data[1] = tahunField.getText();                
        data[2] = kategoripendudukField.getText();
        data[3] = nilaikategoripendudukField.getText();
        data[4] = kodeprovinsi.getText();
        data[5] = jeniskelamin.getText();
        data[6] = referensiField.getText();
        ...
        data[8] = (data25!=null?data25:"");
        data[9] = "" + idlogaudit;
        data[10] = kodependudukField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodependudukField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodependudukLabel = new javax.swing.JLabel();
        jumlahpendudukLabel = new javax.swing.JLabel();
        tahunLabel = new javax.swing.JLabel();
        kategoripendudukLabel = new javax.swing.JLabel();
        nilaikategoripendudukLabel = new javax.swing.JLabel();
        ...
        kodependudukField = new javax.swing.JFormattedTextField();
        jumlahpendudukField = new javax.swing.JFormattedTextField();
        tahunField = new javax.swing.JFormattedTextField();
        kategoripendudukField = new javax.swing.JTextField();
        nilaikategoripendudukField = new javax.swing.JTextField();
        kodeprovinsiField = new javax.swing.JComboBox();
        jeniskelaminField = new javax.swing.JComboBox();
        referensiField = new javax.swing.JTextField();
        ...
        kodependudukLabel.setText("Kode Penduduk:");
        panelLabel.add(kodependudukLabel);

        jumlahpendudukLabel.setText("Jumlah Penduduk:");
        panelLabel.add(jumlahpendudukLabel);

        tahunLabel.setText("Tahun:");
        panelLabel.add(tahunLabel);

        kategoripendudukLabel.setText("Kategori Penduduk:");
        panelLabel.add(kategoripendudukLabel);

        nilaikategoripendudukLabel.setText("Nilai Kategori Penduduk:");
        panelLabel.add(nilaikategoripendudukLabel);
        ...
        referensiLabel.setText("Referensi:");
        panelLabel.add(referensiLabel);
        ...
        kodependudukField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodependudukField);

        jumlahpendudukField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(jumlahpendudukField);

        try {
            tahunField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        panelTextField.add(tahunField);
        panelTextField.add(kategoripendudukField);
        panelTextField.add(nilaikategoripendudukField);

        panelTextField.add(kodeprovinsiField);

        panelTextField.add(jeniskelaminField);
        panelTextField.add(referensiField);
    ...
    private javax.swing.JFormattedTextField jumlahpendudukField;
    private javax.swing.JLabel jumlahpendudukLabel;
    private javax.swing.JTextField kategoripendudukField;
    private javax.swing.JLabel kategoripendudukLabel;
    private javax.swing.JFormattedTextField kodependudukField;
    private javax.swing.JLabel kodependudukLabel;
    private javax.swing.JComboBox kodeprovinsiField;
    private javax.swing.JLabel kodeprovinsiLabel;
    private javax.swing.JTextField nilaikategoripendudukField;
    private javax.swing.JLabel nilaikategoripendudukLabel;
    ...
    private javax.swing.JTextField referensiField;
