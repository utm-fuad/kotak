...
import Model.ModelTransaksiTenagaAhli;
import metromini.*;
 ...
 * @author asus
 */
public class TenagaAhli extends javax.swing.JPanel {
    ...
    Model.ModelTransaksiTenagaAhli model;
    private JTextField posisi;  
    ...
    private int kodetenagaahli, idlogaudit;
    ...
    public TenagaAhli(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelTransaksiTenagaAhli();
        IDlogauditLabel.setVisible(false);
        IDlogauditField.setVisible(false);
        kodetenagaahliField.setVisible(false);
        kodematakuliahLabel.setVisible(false);
    ...
    private void initPKAutoIncrement() {
        query = "select \"Kode_tenaga_ahli\" " +
                " from pdpt_dev.\"TRAN_TENAGA_AHLI\" " +
                " order by \"Kode_tenaga_ahli\" desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        if (data[0][0] == null) {
            kodetenagaahli = 1;
        } else {
            kodetenagaahli = Integer.parseInt(data[0][0]);
            kodetenagaahli++;            
        }
        System.out.println("kodetenagaahli: " + kodetenagaahli);
    }
    ...
    private void initAutoComplete() {
        kompletTextFieldCombo1 = new KompletTextFieldCombo(kon, 
                posisiField, posisi);        
        String [][] datanya1 = {{"1", "Penelitian"},{"2", "Guest Lecturer"},
            {"3", "Consultant"}}; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(datanya1);
        posisi = kompletTextFieldCombo1.dapatkanTextField();
        posisiField = kompletTextFieldCombo1.dapatkanComboBox();
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_TENAGA_AHLI\"";
        kon = homePage.dapatkanKoneksiDB();
        query = "select \"Nama_tenaga_ahli\",\"Posisi\",\"Profesi\",\"Kode_perguruan_tinggi\","
                + "\"Kode_program_studi\",\"Kode_mata_kuliah\" from " + namaTabel +"where \"Kode_perguruan_tinggi\"='"+kodept+"'";
        kon.selectData(query);     
    ...
    public TenagaAhli(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodetenagaahliField.setText("" + kodetenagaahli);
        namatenagaahliField.setText("");
        posisi.setText("");
        profesiField.setText("");
        ...
        namatenagaahliField.requestFocus();
    }
...
//        kodetenagaahliField.setText(tabel.getValueAt(row, 0).toString());
        namatenagaahliField.setText(tabel.getValueAt(row, 0).toString());        
        posisi.setText(tabel.getValueAt(row, 1).toString());
        profesiField.setText(tabel.getValueAt(row, 2).toString());
        kodeperguruantinggiField.setText(tabel.getValueAt(row, 3).toString());
        kodeprogramstudi.setText(tabel.getValueAt(row, 4).toString());
        kodematakuliah.setText(tabel.getValueAt(row, 5).toString());
        //IDlogauditField.setText(tabel.getValueAt(row, 7).toString());
    }
    
    public String [] dapatkanNilaiUntukInsert() {
        String [] data = new String[jmlKolom];
//        data[0] = (!kodetenagaahliField.getText().equals("")?kodetenagaahliField.getText():"0");
        data[0] = (!namatenagaahliField.getText().equals("")?namatenagaahliField.getText():"X");
        
        String dataposisimentah = posisi.getText();
        System.out.println("data posisi mentah: " + dataposisimentah);
        String [] dataposisi = dataposisimentah.split(" ");
        System.out.println("data posisi yg dipilih: " + dataposisi[0]);
        data[1] = dataposisi[0];
        
        data[2] = (!profesiField.getText().equals("")?profesiField.getText():"X");
    ...
    private void initComponents() {
        ...
        profesiLabel = new javax.swing.JLabel();
        ...
        kodetenagaahliField = new javax.swing.JFormattedTextField();
        namatenagaahliField = new javax.swing.JTextField();
        posisiField = new javax.swing.JComboBox();
        profesiField = new javax.swing.JTextField();
        ...
        namatenagaahliLabel.setText("Nama Tenaga Ahli:");
        panelLabel.add(namatenagaahliLabel);

        posisiLabel.setText("Posisi:");
        panelLabel.add(posisiLabel);

        profesiLabel.setText("Profesi:");
        panelLabel.add(profesiLabel);
        ...
        kodetenagaahliField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodetenagaahliField);
        panelTextField.add(namatenagaahliField);

        panelTextField.add(posisiField);
        panelTextField.add(profesiField);
...
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JFormattedTextField kodetenagaahliField;
    private javax.swing.JLabel kodetenagaahliLabel;
    private javax.swing.JTextField namatenagaahliField;
    ...
    private javax.swing.JComboBox posisiField;
    private javax.swing.JLabel posisiLabel;
    private javax.swing.JTextField profesiField;
    private javax.swing.JLabel profesiLabel;
