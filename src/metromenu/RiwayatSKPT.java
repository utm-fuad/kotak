...
import Model.ModelTransaksiRiwayatSKPT;
import metromini.*;
 ...
 * @author asus
 */
public class RiwayatSKPT extends javax.swing.JPanel {
    ...
    Model.ModelTransaksiRiwayatSKPT model;
    ...
    public RiwayatSKPT(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelTransaksiRiwayatSKPT();
        IDlogauditLabel.setVisible(false);
        IDlogauditField.setVisible(false);
        koderiwayatskptField.setVisible(false);
        koderiwayatskptLabel.setVisible(false);
    ...
    private void initAutoComplete() {
        ...
        statuspt = kompletTextFieldCombo1.dapatkanTextField();
        statusprodiField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_RIWAYAT_SK_PT\"";
        kon = homePage.dapatkanKoneksiDB();
        query = "select \"Kode_perguruan_tinggi\",\"Tahun_pelaporan\",\"Semester_pelaporan\","
                + "\"No_SK_berdiri\",\"Tgl_SK_berdiri\",\"Status_pt\" from " + namaTabel +" where \"Kode_perguruan_tinggi\"='"+kodept+"'";
        kon.selectData(query);     
    ...
    public RiwayatSKPT(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        ...
        koderiwayatskptField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        koderiwayatskptField.setText(tabel.getValueAt(row, 0).toString());
...
//        data[0] = (!koderiwayatskptField.getText().equals("")?koderiwayatskptField.getText():"0");
        ...
        data[3] = (!noSKBerdiriField.getText().equals("")?noSKBerdiriField.getText():"X");
        ...
        System.out.println("data statuspt mentah: " + datastatusptmentah);
        String [] datastatuspt = datastatusptmentah.split(" ");
        System.out.println("data statuspt yg dipilih: " + datastatuspt[0]);
    ...
    private void initComponents() {
        ...
        koderiwayatskptLabel = new javax.swing.JLabel();
        ...
        koderiwayatskptField = new javax.swing.JFormattedTextField();
        ...
        koderiwayatskptLabel.setText("Kode Riwayat SK PT:");
        panelLabel.add(koderiwayatskptLabel);
        ...
        koderiwayatskptField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(koderiwayatskptField);
...
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JFormattedTextField koderiwayatskptField;
    private javax.swing.JLabel koderiwayatskptLabel;
