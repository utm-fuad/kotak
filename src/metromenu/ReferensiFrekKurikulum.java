 ...
 * @author asus
 */
public class ReferensiFrekKurikulum extends javax.swing.JPanel {
     ...
     */
    public ReferensiFrekKurikulum() {    
        initComponents();
    }
    
    public ReferensiFrekKurikulum(HomePage _homePage, String _namaTabel) {
        this();
    ...
    public ReferensiFrekKurikulum(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        kodefrekkurikulumField.setText("");
        namafrekkurikulumField.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        
        kodefrekkurikulumField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodefrekkurikulumField.setText(tabel.getValueAt(row, 0).toString());        
        namafrekkurikulumField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodefrekkurikulumField.getText().equals("")?kodefrekkurikulumField.getText():"X");
        data[1] = (!namafrekkurikulumField.getText().equals("")?namafrekkurikulumField.getText():"X");        
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namafrekkurikulumField.getText();                
        ...
        data[3] = "" + idlogaudit;
        data[4] = kodefrekkurikulumField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodefrekkurikulumField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodefrekkurikulumLabel = new javax.swing.JLabel();
        namafrekkurikulumLabel = new javax.swing.JLabel();
        ...
        kodefrekkurikulumField = new javax.swing.JTextField();
        namafrekkurikulumField = new javax.swing.JTextField();
        ...
        kodefrekkurikulumLabel.setText("Kode Frek Kurikulum:");
        panelLabel.add(kodefrekkurikulumLabel);

        namafrekkurikulumLabel.setText("Nama Frek Kurikulum:");
        panelLabel.add(namafrekkurikulumLabel);
        ...
        panelTextField.add(kodefrekkurikulumField);
        panelTextField.add(namafrekkurikulumField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET Nama_frek_kurikulum=?, " + 
        "Tgl_mulai_efektif=?, " +
        "Tgl_akhir_efektif=?, " +
        "ID_log_audit=? " +
        " WHERE Kode_frek_kurikulum=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JTextField kodefrekkurikulumField;
    private javax.swing.JLabel kodefrekkurikulumLabel;
    private javax.swing.JTextField namafrekkurikulumField;
    private javax.swing.JLabel namafrekkurikulumLabel;
