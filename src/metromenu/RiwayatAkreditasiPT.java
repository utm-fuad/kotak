...
import Model.ModelRiwayatAkreditasiPT;
import metromini.*;
 ...
 * @author asus
 */
public class RiwayatAkreditasiPT extends javax.swing.JPanel {
    ...
    Model.ModelRiwayatAkreditasiPT model;    
     ...
     */
    public RiwayatAkreditasiPT() {    
        initComponents();
    }
    
    public RiwayatAkreditasiPT(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelRiwayatAkreditasiPT();
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_RIWAYAT_AKREDITASI_PT\"";
    ...
    public RiwayatAkreditasiPT(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        koderiwayatakreditasiptField.setText("");
        ...
        koderiwayatakreditasiptField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        koderiwayatakreditasiptField.setText(tabel.getValueAt(row, 0).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!koderiwayatakreditasiptField.getText().equals("")?koderiwayatakreditasiptField.getText():"0");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[3] = (!kodeakreditasiField.getText().equals("")?kodeakreditasiField.getText():"0");        
        data[4] = (!noSKBANField.getText().equals("")?noSKBANField.getText():"X");
        ...
        data[6] = "" + idlogaudit;
        data[7] = (!koderiwayatakreditasiptField.getText().equals("")?koderiwayatakreditasiptField.getText():"0");
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = koderiwayatakreditasiptField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        koderiwayatakreditasiptLabel = new javax.swing.JLabel();
        ...
        koderiwayatakreditasiptField = new javax.swing.JFormattedTextField();
        ...
        koderiwayatakreditasiptLabel.setText("Kode Riwayat Akreditasi PT:");
        panelLabel.add(koderiwayatakreditasiptLabel);
        ...
        koderiwayatakreditasiptField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(koderiwayatakreditasiptField);
...
//            dapatkanNilaiUntukInsert() );
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " \"Tgl_SK_BAN\"=?, " +
        " \"ID_log_audit\"=? " +
        " WHERE \"Kode_riwayat_akreditasi_pt\"=? ";
//        int hasil = kon.insertUpdateDeleteData(query,
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JFormattedTextField koderiwayatakreditasiptField;
    private javax.swing.JLabel koderiwayatakreditasiptLabel;
