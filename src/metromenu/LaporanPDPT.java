 ...
 * @author asus
 */
public class LaporanPDPT extends javax.swing.JPanel {
    ...
    public LaporanPDPT(HomePage _homePage, String _namaTabel) {
        this();
...
//        initAutoComplete();
    ...
    private void initPKAutoIncrement() {
        query = "select \"Kode_SMS\" " +
                " from pdpt_dev.\"TMST_SMS_PRODI\" " +
                " order by \"KODE_SMS\" desc";
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_LAPORAN_PDPT\"";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by \"Kode_perguruan_tinggi\" desc";
        kon.selectData(query);     
    ...
    public LaporanPDPT(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        KodePTField.setText("");
        KodeProdiField.setText("");
        KodeSemesterField.setText("");
        nidnnuk.setText("");
        KodeProdiField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        KodeProdiField.setText(tabel.getValueAt(row, 1).toString());        
        KodeSemesterField.setText(tabel.getValueAt(row, 2).toString());
...
//        kategoriHKI.setText(tabel.getValueAt(row, 7).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!KodePTField.getText().equals("")?KodePTField.getText():"0");
        data[1] = (!KodeProdiField.getText().equals("    ")?KodeProdiField.getText():"0000");
        data[2] = (!KodeSemesterField.getText().equals(" ")?KodeSemesterField.getText():"0");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                
        data[0] = KodeSemesterField.getText();
         data[1] = KodePTField.getText();
        data[2] = KodeProdiField.getText();
    ...
    public String[] dapatkanNilaiUntukDelete(){
        ...
        data[1] = KodeProdiField.getText();
        data[2] = KodeSemesterField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        KodeProdiField = new javax.swing.JFormattedTextField();
        KodeSemesterField = new javax.swing.JFormattedTextField();
        ...
        kodeHKILabel.setText("Kode Perguruan Tinggi :");
        panelLabel.add(kodeHKILabel);

        tahunpelaporanLabel.setText("Kode Program Studi:");
        panelLabel.add(tahunpelaporanLabel);

        semesterpelaporanLabel.setText("Semester :");
        ...
        try {
            KodeProdiField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        panelTextField.add(KodeProdiField);

        try {
            KodeSemesterField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("#")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        panelTextField.add(KodeSemesterField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " \"Semester\"=? "+
        " WHERE " + 
        " \"Kode_Perguruan_Tinggi\"=? And \"Kode_Program_Studi\"=?";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        if (hasil == 1) {
            query = "select * from " + namaTabel + " order by \"Kode_Program_Studi\" desc";
            kon.selectData(query);
            tampilkanDataKeTabel(kon.dapatkanData(), ubahLabelKeSentenceCase(kon.dapatkanKolom()));
            persiapanEntriDataBaru();
    ...
    private javax.swing.JFormattedTextField KodeProdiField;
    private javax.swing.JFormattedTextField KodeSemesterField;
