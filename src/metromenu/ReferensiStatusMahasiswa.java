 ...
 * @author asus
 */
public class ReferensiStatusMahasiswa extends javax.swing.JPanel {
     ...
     */
    public ReferensiStatusMahasiswa() {    
        initComponents();
    }
    
    public ReferensiStatusMahasiswa(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_STATUS_MAHASISWA";
    ...
    public ReferensiStatusMahasiswa(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        kodestatusmahasiswaField.setText("");
        ...
        kodestatusmahasiswaField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodestatusmahasiswaField.setText(tabel.getValueAt(row, 0).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodestatusmahasiswaField.getText().equals("")?kodestatusmahasiswaField.getText():"0");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[4] = "" + idlogaudit;//ini yg benar dan sudah teruji
        data[5] = kodestatusmahasiswaField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodestatusmahasiswaField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodestatusmahasiswaLabel = new javax.swing.JLabel();
        ...
        kodestatusmahasiswaField = new javax.swing.JTextField();
        ...
        kodestatusmahasiswaLabel.setText("Kode Status Mahasiswa:");
        panelLabel.add(kodestatusmahasiswaLabel);
        ...
        kodestatusmahasiswaField.setColumns(1);
        panelTextField.add(kodestatusmahasiswaField);
    ...
    private javax.swing.JTextField kodestatusmahasiswaField;
    private javax.swing.JLabel kodestatusmahasiswaLabel;
