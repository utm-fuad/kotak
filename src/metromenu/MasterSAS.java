 ...
 * @author asus
 */
public class MasterSAS extends javax.swing.JPanel {
    ...
    public MasterSAS(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelMasterSAS();
    ...
    private void initAutoComplete() {
        kompletTextFieldCombo1 = new KompletTextFieldCombo(kon, 
                kodePTField, kodepublikasidosentetap);        
        query = "select \"Kode_perguruan_tinggi\" " +
        ...
        kodePTField = kompletTextFieldCombo1.dapatkanComboBox();
        
        kompletTextFieldCombo2 = new KompletTextFieldCombo(kon, 
                kodeProdiField, kodetenagaahli);        
        query = "select \"Kode_program_studi\" " +
                " from pdpt_dev.\"TMST_PROGRAM_STUDI\""; 
        kompletTextFieldCombo2.initDataUtkAutoComplete(query);        
        kodetenagaahli = kompletTextFieldCombo2.dapatkanTextField();
        kodeProdiField = kompletTextFieldCombo2.dapatkanComboBox();
    }
    ...
    public MasterSAS(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        String datakodepublikasidosentetapmentah = kodePTField.getSelectedItem().toString();
        System.out.println("data kodepublikasidosentetap mentah: " + datakodepublikasidosentetapmentah);
        String [] datakodepublikasidosentetap = datakodepublikasidosentetapmentah.split(" ");
        System.out.println("data kodepublikasidosentetap yg dipilih: " + datakodepublikasidosentetap[0]);
        data[1] = datakodepublikasidosentetapmentah;
        
        String datakodetenagaahlimentah = kodeProdiField.getSelectedItem().toString();
        System.out.println("data kodetenagaahli mentah: " + datakodetenagaahlimentah);
        String [] datakodetenagaahli = datakodetenagaahlimentah.split(" ");
        System.out.println("data kodetenagaahli yg dipilih: " + datakodetenagaahli[0]);
        data[2] = datakodetenagaahlimentah;
    ...
    private void initComponents() {
        ...
        kodePTField = new javax.swing.JComboBox();
        kodeProdiField = new javax.swing.JComboBox();
        ...
        kodeanggotapenelitiahliLabel.setText("ID:");
        panelLabel.add(kodeanggotapenelitiahliLabel);

        kodepublikasidosentetapLabel.setText("Kode Perguruan Tinggi:");
        panelLabel.add(kodepublikasidosentetapLabel);

        kodetenagaahliLabel.setText("Kode Program Studi");
        panelLabel.add(kodetenagaahliLabel);

        IDlogauditLabel.setText("Persentase :");
...
//            dapatkanNilaiUntukInsert() );
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET \"persentase\"=? "+
        " WHERE \"Kode_perguruan_tinggi\"=? and \"Kode_program_studi\"=?";
//        int hasil = kon.insertUpdateDeleteData(query,
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JComboBox kodePTField;
    private javax.swing.JComboBox kodeProdiField;
