...
import Model.ModelAnggotaPenelitianPendukung;
import metromini.*;
 ...
 * @author asus
 */
public class AnggotaPenelitiPendukung extends javax.swing.JPanel {
    ...
    private int barisYgDipilih = 0;
     private Model.ModelAnggotaPenelitianPendukung model;
    private JTextField kodepublikasidosentetap;  
    private koneksi.KompletTextFieldCombo kompletTextFieldCombo1;
    private JTextField kodetenagapendukung;  
    private koneksi.KompletTextFieldCombo kompletTextFieldCombo2;
    
    private int kodeanggotapenelitidukung=0, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public AnggotaPenelitiPendukung() {    
        initComponents();
    }
    
    public AnggotaPenelitiPendukung(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelAnggotaPenelitianPendukung();
    ...
    private void initPKAutoIncrement() {
        query = "select \"Kode_anggota_peneliti_dukung\"" +
                " from pdpt_dev.\"TRAN_ANGGOTA_PENELITI_DUKUNG\" " +
                " order by \"Kode_anggota_peneliti_dukung\" desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        try{
        kodeanggotapenelitidukung = Integer.parseInt(data[0][0]);
        kodeanggotapenelitidukung++;
        System.out.println("kodeanggotapenelitidukung: " + kodeanggotapenelitidukung);
        }catch(Exception e){
            kodeanggotapenelitidukung=1;
        }
    }
    ...
    private void initAutoComplete() {
        ...
        kompletTextFieldCombo2 = new KompletTextFieldCombo(kon, 
                kodetenagapendukungField, kodetenagapendukung);        
        query = "select \"Kode_tenaga_pendukung\", \"Nama_tenaga_pendukung\" " +
                " from pdpt_dev.\"TRAN_TENAGA_PENDUKUNG\""; 
        kompletTextFieldCombo2.initDataUtkAutoComplete(query);        
        kodetenagapendukung = kompletTextFieldCombo2.dapatkanTextField();
        kodetenagapendukungField = kompletTextFieldCombo2.dapatkanComboBox();
    }
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_ANGGOTA_PENELITI_DUKUNG\"";
    ...
    public AnggotaPenelitiPendukung(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodeanggotapenelitidukungField.setText("" + kodeanggotapenelitidukung);
        kodepublikasidosentetap.setText("");
        kodetenagapendukung.setText("");
        IDlogauditField.setText("");
        
        kodeanggotapenelitidukungField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeanggotapenelitidukungField.setText(tabel.getValueAt(row, 0).toString());
        kodepublikasidosentetap.setText(tabel.getValueAt(row, 1).toString());        
        kodetenagapendukung.setText(tabel.getValueAt(row, 2).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeanggotapenelitidukungField.getText().equals("")?kodeanggotapenelitidukungField.getText():"0");
        ...
        data[1] = datakodepublikasidosentetap[0];
        
        String datakodetenagapendukungmentah = kodetenagapendukung.getText();
        System.out.println("data kodetenagapendukung mentah: " + datakodetenagapendukungmentah);
        String [] datakodetenagapendukung = datakodetenagapendukungmentah.split(" ");
        System.out.println("data kodetenagapendukung yg dipilih: " + datakodetenagapendukung[0]);
        data[2] = datakodetenagapendukung[0];
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        String [] datakodetenagapendukung = datakodetenagapendukungmentah.split(" ");
        System.out.println("data kodetenagapendukung yg dipilih: " + datakodetenagapendukung[0]);
        data[1] = datakodetenagapendukung[0];
        
        data[2] = "" + idlogaudit;
        data[3] = kodeanggotapenelitidukungField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodeanggotapenelitidukungField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodeanggotapenelitidukungLabel = new javax.swing.JLabel();
        ...
        kodeanggotapenelitidukungField = new javax.swing.JFormattedTextField();
        kodepublikasidosentetapField = new javax.swing.JComboBox();
        kodetenagapendukungField = new javax.swing.JComboBox();
        ...
        kodeanggotapenelitidukungLabel.setText("Kode Anggota Peneliti Dukung:");
        panelLabel.add(kodeanggotapenelitidukungLabel);
        ...
        kodeanggotapenelitidukungField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodeanggotapenelitidukungField);
...
//            dapatkanNilaiUntukInsert() );
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        "\"ID_log_audit\"=? " +
        " WHERE \"Kode_anggota_peneliti_dukung\"=? ";
//        int hasil = kon.insertUpdateDeleteData(query,
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JFormattedTextField kodeanggotapenelitidukungField;
    private javax.swing.JLabel kodeanggotapenelitidukungLabel;
    private javax.swing.JComboBox kodepublikasidosentetapField;
    private javax.swing.JLabel kodepublikasidosentetapLabel;
    private javax.swing.JComboBox kodetenagapendukungField;
