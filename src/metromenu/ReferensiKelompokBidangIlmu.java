 ...
 * @author asus
 */
public class ReferensiKelompokBidangIlmu extends javax.swing.JPanel {
    ...
    private int /*kodekelompokbidangilmu,*/ idlogaudit;
     ...
     */
    public ReferensiKelompokBidangIlmu() {    
        initComponents();
    }
    
    public ReferensiKelompokBidangIlmu(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initIDLogAudit() {
        /*//tidak perlu menggunakan ini karena tipe data char(1)
        query = "select Kode_kelompok_bidang_ilmu " +
                " from TREF_KELOMPOK_BIDANG_ILMU " +
                " order by Kode_kelompok_bidang_ilmu desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodekelompokbidangilmu = Integer.parseInt(data[0][0]);
        kodekelompokbidangilmu++;
        System.out.println("KodeKopertis: " + kodekelompokbidangilmu);
        */
    ...
    private void initAutoComplete() {
        ...
        String [][] datanya1 = {{"1", "Belum diverifikasi"},
        ...
        statusvalidasi = kompletTextFieldCombo1.dapatkanTextField();
        statusvalidasiField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_KELOMPOK _BIDANG_ILMU";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by Kode_kelompok_bidang_ilmu desc";
        kon.selectData(query);     
    ...
    public ReferensiKelompokBidangIlmu(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodekelompokbidangilmuField.setText(tabel.getValueAt(row, 0).toString());
        namabidangilmuField.setText(tabel.getValueAt(row, 1).toString());
        statusvalidasi.setText(tabel.getValueAt(row, 2).toString());        
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodekelompokbidangilmuField.getText().equals("")?kodekelompokbidangilmuField.getText():"0");
        data[1] = (!namabidangilmuField.getText().equals("")?namabidangilmuField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namabidangilmuField.getText();                
        data[1] = statusvalidasi.getText();
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodekelompokbidangilmuField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodekelompokbidangilmuField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namabidangilmuLabel = new javax.swing.JLabel();
        ...
        kodekelompokbidangilmuField = new javax.swing.JTextField();
        namabidangilmuField = new javax.swing.JTextField();
        ...
        namabidangilmuLabel.setText("Nama Bidang Ilmu:");
        panelLabel.add(namabidangilmuLabel);
        ...
        panelTextField.add(namabidangilmuField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET Nama_bidang_ilmu=?, " +
        "Status_validasi=?, " +        
        "Tgl_mulai_efektif=?, " +
        "Tgl_akhir_efektif=?, " +
        "ID_log_audit=? " +
        " WHERE Kode_kelompok_bidang_ilmu=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JTextField kodekelompokbidangilmuField;
    private javax.swing.JLabel kodekelompokbidangilmuLabel;
    private javax.swing.JTextField namabidangilmuField;
    private javax.swing.JLabel namabidangilmuLabel;
