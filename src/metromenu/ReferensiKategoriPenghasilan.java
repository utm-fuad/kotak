 ...
 * @author asus
 */
public class ReferensiKategoriPenghasilan extends javax.swing.JPanel {
    ...
    private int kodekategoripenghasilan, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiKategoriPenghasilan() {    
        initComponents();
    }
    
    public ReferensiKategoriPenghasilan(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_kategori_penghasilan " +
                " from TREF_KATEGORI_PENGHASILAN " +
                " order by Kode_kategori_penghasilan desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodekategoripenghasilan = Integer.parseInt(data[0][0]);
        kodekategoripenghasilan++;
        System.out.println("KodeKopertis: " + kodekategoripenghasilan);
    }
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_KATEGORI_PENGHASILAN";
    ...
    public ReferensiKategoriPenghasilan(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodekategoripenghasilanField.setText("" + kodekategoripenghasilan);        
        rangepenghasilanminField.setText("");
        rangepenghasilanmaxField.setText("");
        sumberpenghasilanField.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        
        rangepenghasilanminField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodekategoripenghasilanField.setText(tabel.getValueAt(row, 0).toString());        
        rangepenghasilanminField.setText(tabel.getValueAt(row, 1).toString());
        rangepenghasilanmaxField.setText(tabel.getValueAt(row, 2).toString());
        sumberpenghasilanField.setText(tabel.getValueAt(row, 3).toString());        
                
        String strKalendar = tabel.getValueAt(row, 4).toString();
        ...
        strKalendar = tabel.getValueAt(row, 5).toString();
        System.out.println("kalendar: " + strKalendar);
        System.out.println("tahun: " + strKalendar.substring(0, 4));
        System.out.println("bulan: " + strKalendar.substring(5, 7));
        System.out.println("hari: " + strKalendar.substring(8, 10));
        ...
        //IDlogauditField.setText(tabel.getValueAt(row, 6).toString());
    }
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodekategoripenghasilanField.getText().equals("")?kodekategoripenghasilanField.getText():"0");
        data[1] = (!rangepenghasilanminField.getText().equals("")?rangepenghasilanminField.getText():"0");
        data[2] = (!rangepenghasilanmaxField.getText().equals("")?rangepenghasilanmaxField.getText():"0");
        data[3] = (!sumberpenghasilanField.getText().equals("")?sumberpenghasilanField.getText():"X");        
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = rangepenghasilanminField.getText();                
        data[1] = rangepenghasilanmaxField.getText();                                
        data[2] = sumberpenghasilanField.getText();                                
        ...
        bulan = namaBulan[kalendar.get(Calendar.MONTH)];
        tahun = kalendar.get(Calendar.YEAR);        
        String data3 = tahun + "-" + kalendar.get(Calendar.MONTH) + "-" + hari;
        data[3] = (data3!=null?data3:"");
        ...
        data[5] = "" + idlogaudit;
        data[6] = kodekategoripenghasilanField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodekategoripenghasilanField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        rangepenghasilanminLabel = new javax.swing.JLabel();
        rangepenghasilanmaxLabel = new javax.swing.JLabel();
        kodepulauLabel = new javax.swing.JLabel();
        ...
        kodekategoripenghasilanField = new javax.swing.JFormattedTextField();
        rangepenghasilanminField = new javax.swing.JFormattedTextField();
        rangepenghasilanmaxField = new javax.swing.JFormattedTextField();
        sumberpenghasilanField = new javax.swing.JTextField();
        ...
        rangepenghasilanminLabel.setText("Range Penghasilan Min:");
        panelLabel.add(rangepenghasilanminLabel);

        rangepenghasilanmaxLabel.setText("Range Penghasilan Max:");
        panelLabel.add(rangepenghasilanmaxLabel);

        kodepulauLabel.setText("Sumber Penghasilan:");
        panelLabel.add(kodepulauLabel);
        ...
        kodekategoripenghasilanField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodekategoripenghasilanField);

        rangepenghasilanminField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(rangepenghasilanminField);

        rangepenghasilanmaxField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(rangepenghasilanmaxField);
        panelTextField.add(sumberpenghasilanField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET Range_penghasilan_min=?, " + 
        "Range_penghasilan_max=?, " +        
        "Sumber_penghasilan=?, " +                        
        "Tgl_mulai_efektif=?, " +
        "Tgl_akhir_efektif=?, " +        
        "ID_log_audit=? " +
        " WHERE Kode_kategori_penghasilan=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JFormattedTextField kodekategoripenghasilanField;
    private javax.swing.JLabel kodekategoripenghasilanLabel;
    private javax.swing.JLabel kodepulauLabel;
    ...
    private javax.swing.JFormattedTextField rangepenghasilanmaxField;
    private javax.swing.JLabel rangepenghasilanmaxLabel;
    private javax.swing.JFormattedTextField rangepenghasilanminField;
    private javax.swing.JLabel rangepenghasilanminLabel;
    private javax.swing.JTextField sumberpenghasilanField;
