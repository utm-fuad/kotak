 ...
 * @author asus
 */
public class ReferensiJenjangPendidikan extends javax.swing.JPanel {
    ...
    private int kodejenjangpendidikan, idlogaudit;
    private String kueri;
    
    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiJenjangPendidikan() {    
        initComponents();
    }
    
    public ReferensiJenjangPendidikan(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_jenjang_pendidikan " +
                " from TREF_JENJANG_PENDIDIKAN " +
                " order by Kode_jenjang_pendidikan desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodejenjangpendidikan = Integer.parseInt(data[0][0]);
        kodejenjangpendidikan++;
        System.out.println("KodeJenjangPendidikan: " + kodejenjangpendidikan);
    }
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_JENJANG_PENDIDIKAN";
    ...
    public ReferensiJenjangPendidikan(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodejenjangpendidikanField.setText("" + kodejenjangpendidikan);        
        deskripsiField.setText("");
        waktupelaksanaanjenjangpendField.setText("");
        groupjenjangstudiField.setText("");
    ...
    private void tampilkanData(int row) {
        ...
        kodejenjangpendidikanField.setText(tabel.getValueAt(row, 0).toString());        
        deskripsiField.setText(tabel.getValueAt(row, 1).toString());
        waktupelaksanaanjenjangpendField.setText(tabel.getValueAt(row, 2).toString());
        groupjenjangstudiField.setText(tabel.getValueAt(row, 3).toString());        
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodejenjangpendidikanField.getText().equals("")?kodejenjangpendidikanField.getText():"0");
        data[1] = (!deskripsiField.getText().equals("")?deskripsiField.getText():"X");
        data[2] = (!waktupelaksanaanjenjangpendField.getText().equals("")?waktupelaksanaanjenjangpendField.getText():"X");
        data[3] = (!groupjenjangstudiField.getText().equals("")?groupjenjangstudiField.getText():"X");        
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[1] = waktupelaksanaanjenjangpendField.getText();                                
        data[2] = groupjenjangstudiField.getText();                                
        ...
        data[5] = "" + idlogaudit;
        data[6] = kodejenjangpendidikanField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodejenjangpendidikanField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        waktupelaksanaanjenjangpendLabel = new javax.swing.JLabel();
        groupjenjangstudiLabel = new javax.swing.JLabel();
        ...
        kodejenjangpendidikanField = new javax.swing.JFormattedTextField();
        deskripsiField = new javax.swing.JTextField();
        waktupelaksanaanjenjangpendField = new javax.swing.JTextField();
        groupjenjangstudiField = new javax.swing.JTextField();
        ...
        waktupelaksanaanjenjangpendLabel.setText("Waktu Pelaksanaan Jenjang Pendidikan:");
        panelLabel.add(waktupelaksanaanjenjangpendLabel);

        groupjenjangstudiLabel.setText("Group Jenjang Studi:");
        panelLabel.add(groupjenjangstudiLabel);
        ...
        kodejenjangpendidikanField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodejenjangpendidikanField);
        panelTextField.add(deskripsiField);
        panelTextField.add(waktupelaksanaanjenjangpendField);
        panelTextField.add(groupjenjangstudiField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET Deskripsi=?, " + 
        "Waktu_pelaksanaan_jenjang_pend=?, " +        
        "Group_jejang_studi=?, " +                        
        "Tgl_mulai_efektif=?, " +
        "Tgl_akhir_efektif=?, " +        
        "ID_log_audit=? " +
        " WHERE Kode_jenjang_pendidikan=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JTextField groupjenjangstudiField;
    private javax.swing.JLabel groupjenjangstudiLabel;
    private javax.swing.JScrollPane gulungPanelAtribut;
    private javax.swing.JScrollPane gulungTabel;
    private javax.swing.JSplitPane jSplitPane1;
    private javax.swing.JSplitPane jSplitPane2;
    private javax.swing.JFormattedTextField kodejenjangpendidikanField;
    ...
    private javax.swing.JTextField waktupelaksanaanjenjangpendField;
    private javax.swing.JLabel waktupelaksanaanjenjangpendLabel;
