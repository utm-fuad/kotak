 ...
 * @author asus
 */
public class ReferensiStatusAktivitasDosen extends javax.swing.JPanel {
    ...
    private int kodestatusaktivitasdosen, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiStatusAktivitasDosen() {    
        initComponents();
    }
    
    public ReferensiStatusAktivitasDosen(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_STATUS_AKTIVITAS_DOSEN";
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_status_aktivitas_dosen " +
                " from TREF_STATUS_AKTIVITAS_DOSEN " +
                " order by Kode_status_aktivitas_dosen desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodestatusaktivitasdosen = Integer.parseInt(data[0][0]);
        kodestatusaktivitasdosen++;
        System.out.println("kodestatusaktivitasdosen: " + kodestatusaktivitasdosen);
    }
    ...
    public ReferensiStatusAktivitasDosen(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        ...
        kodestatusaktivitasdosenField.setText("" + kodestatusaktivitasdosen);
        namastatusField.setText("");
        keteranganField.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        
        namastatusField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodestatusaktivitasdosenField.setText(tabel.getValueAt(row, 0).toString());
        namastatusField.setText(tabel.getValueAt(row, 1).toString());
        keteranganField.setText(tabel.getValueAt(row, 2).toString());        
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodestatusaktivitasdosenField.getText().equals("")?kodestatusaktivitasdosenField.getText():"0");
        data[1] = (!namastatusField.getText().equals("")?namastatusField.getText():"X");
        data[2] = (!keteranganField.getText().equals("")?keteranganField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namastatusField.getText();                
        data[1] = keteranganField.getText();
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodestatusaktivitasdosenField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodestatusaktivitasdosenField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodestatusaktivitasdosenLabel = new javax.swing.JLabel();
        namastatusLabel = new javax.swing.JLabel();
        keteranganiLabel = new javax.swing.JLabel();
        ...
        kodestatusaktivitasdosenField = new javax.swing.JFormattedTextField();
        namastatusField = new javax.swing.JTextField();
        ...
        kodestatusaktivitasdosenLabel.setText("Kode Status Aktivitas Dosen:");
        panelLabel.add(kodestatusaktivitasdosenLabel);

        namastatusLabel.setText("Nama Status:");
        panelLabel.add(namastatusLabel);

        keteranganiLabel.setText("Keterangan:");
        panelLabel.add(keteranganiLabel);
        ...
        kodestatusaktivitasdosenField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(kodestatusaktivitasdosenField);
        panelTextField.add(namastatusField);
        panelTextField.add(keteranganField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        "Tgl_akhir_efektif=?, " +
        "ID_log_audit=? " +
        " WHERE Kode_status_aktivitas_dosen=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JLabel keteranganiLabel;
    private javax.swing.JFormattedTextField kodestatusaktivitasdosenField;
    private javax.swing.JLabel kodestatusaktivitasdosenLabel;
    private javax.swing.JTextField namastatusField;
    private javax.swing.JLabel namastatusLabel;
