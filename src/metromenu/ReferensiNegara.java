 ...
 * @author asus
 */
public class ReferensiNegara extends javax.swing.JPanel {
    ...
    private int kodenegara, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiNegara() {    
        initComponents();
    }
    
    public ReferensiNegara(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_negara " +
                " from TREF_NEGARA " +
                " order by Kode_negara desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodenegara = Integer.parseInt(data[0][0]);
        kodenegara++;
        System.out.println("kodenegara: " + kodenegara);
    }
    ...
    public ReferensiNegara(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodenegaraField.setText("" + kodenegara);
        namanegaraField.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        kodenegara2Field.setText("");
        kodenegara3Field.setText("");
        LongitudeField.setText("");
        LatitudeField.setText("");
        ZoomField.setText("");
        namanegaraField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodenegaraField.setText(tabel.getValueAt(row, 0).toString());
        namanegaraField.setText(tabel.getValueAt(row, 1).toString());        
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodenegaraField.getText().equals("")?kodenegaraField.getText():"0");        
        data[1] = (!namanegaraField.getText().equals("")?namanegaraField.getText():"X");
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodenegara2Field.getText();
        data[6] = kodenegara3Field.getText();
        data[7] = LatitudeField.getText();
        data[8] = LongitudeField.getText();
        data[9] = ZoomField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namanegaraField.getText();                
        ...
        data[3] = "" + idlogaudit;
        data[4] = kodenegara2Field.getText();
        data[5] = kodenegara3Field.getText();
        data[6] = LatitudeField.getText();
        data[7] = LongitudeField.getText();
        data[8] = ZoomField.getText();
        data[9] = kodenegaraField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodenegaraField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namaneagaraLabel = new javax.swing.JLabel();
        ...
        kodenegaraField = new javax.swing.JFormattedTextField();
        namanegaraField = new javax.swing.JTextField();
        ...
        kodenegara2Field = new javax.swing.JFormattedTextField();
        kodenegara3Field = new javax.swing.JFormattedTextField();
        LatitudeField = new javax.swing.JFormattedTextField();
        LongitudeField = new javax.swing.JFormattedTextField();
        ZoomField = new javax.swing.JFormattedTextField();
        ...
        namaneagaraLabel.setText("Nama Negara:");
        panelLabel.add(namaneagaraLabel);
        ...
        IDlogauditLabel1.setText("Kode Negara 2 :");
        panelLabel.add(IDlogauditLabel1);

        IDlogauditLabel2.setText("Kode Negara 3 :");
        panelLabel.add(IDlogauditLabel2);

        IDlogauditLabel3.setText("Latitude :");
        panelLabel.add(IDlogauditLabel3);

        IDlogauditLabel4.setText("Longitude :");
        panelLabel.add(IDlogauditLabel4);

        IDlogauditLabel5.setText("Zoom :");
        ...
        kodenegaraField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodenegaraField);
        panelTextField.add(namanegaraField);
        ...
        kodenegara2Field.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodenegara2Field);

        kodenegara3Field.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodenegara3Field);

        LatitudeField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(LatitudeField);

        LongitudeField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(LongitudeField);

        ZoomField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(ZoomField);
    ...
    private javax.swing.JFormattedTextField ZoomField;
    ...
    private javax.swing.JFormattedTextField kodenegara2Field;
    private javax.swing.JFormattedTextField kodenegara3Field;
    private javax.swing.JFormattedTextField kodenegaraField;
    private javax.swing.JLabel kodenegaraLabel;
    private javax.swing.JLabel namaneagaraLabel;
    private javax.swing.JTextField namanegaraField;
