...
import Model.ModelTransaksiRiwayatKepemilikanPT;
import metromini.*;
 ...
 * @author asus
 */
public class RiwayatKepemilikanPT extends javax.swing.JPanel {
    ...
    Model.ModelTransaksiRiwayatKepemilikanPT model;
     ...
     */
    public RiwayatKepemilikanPT() {    
        initComponents();
    }
    
    public RiwayatKepemilikanPT(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelTransaksiRiwayatKepemilikanPT();
        IDlogauditLabel.setVisible(false);
        IDlogauditField.setVisible(false);
        koderiwayatkepemilikanptField.setVisible(false);
        koderiwayatkepemilikanptLabel.setVisible(false);
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_RIWAYAT_KEPEMILIKAN_PT\"";
        kon = homePage.dapatkanKoneksiDB();
        query = "select \"Tahun_pelaporan\",\"Semester_pelaporan\",\"Kode_perguruan_tinggi\","
                + "\"Kode_badan_hukum\",\"Tanggal_mulai_efektif\",\"Tanggal_akhir_efektif\" from " + namaTabel;
        kon.selectData(query);     
    ...
    public RiwayatKepemilikanPT(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        koderiwayatkepemilikanptField.setText("");
...
//        koderiwayatkepemilikanptField.setText(tabel.getValueAt(row, 0).toString());
        ...
        kodebadanhukumField.setText(tabel.getValueAt(row, 3).toString());
...
//        data[0] = (!koderiwayatkepemilikanptField.getText().equals("")?koderiwayatkepemilikanptField.getText():"0");
        ...
        data[3] = (!kodebadanhukumField.getText().equals("1      ")?kodebadanhukumField.getText():"1000000");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[0] = (!kodebadanhukumField.getText().equals("1      ")?kodebadanhukumField.getText():"1000000");
    ...
    private void initComponents() {
        ...
        koderiwayatkepemilikanptLabel = new javax.swing.JLabel();
        ...
        kodebahanhukumLabel = new javax.swing.JLabel();
        tanggalmulaiefektifLabel = new javax.swing.JLabel();
        tanggalakhirefektifLabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        koderiwayatkepemilikanptField = new javax.swing.JFormattedTextField();
        ...
        koderiwayatkepemilikanptLabel.setText("Kode Riwayat Kepemilikan PT:");
        panelLabel.add(koderiwayatkepemilikanptLabel);
        ...
        kodebahanhukumLabel.setText("Kode Badan Hukum:");
        panelLabel.add(kodebahanhukumLabel);

        tanggalmulaiefektifLabel.setText("Tanggal Mulai Efektif:");
        panelLabel.add(tanggalmulaiefektifLabel);

        tanggalakhirefektifLabel.setText("Tanggal Akhir Efektif:");
        panelLabel.add(tanggalakhirefektifLabel);
        ...
        koderiwayatkepemilikanptField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(koderiwayatkepemilikanptField);
        ...
        jSplitPane3.setLeftComponent(panelKontrolSIUD);
        ...
        jSplitPane3.setRightComponent(panelKontrolNavigasiRecord);

        panelKontrol.add(jSplitPane3);
...
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JLabel kodebahanhukumLabel;
    private javax.swing.JFormattedTextField kodeperguruantinggiField;
    private javax.swing.JLabel kodeperguruantinggiLabel;
    private javax.swing.JFormattedTextField koderiwayatkepemilikanptField;
    private javax.swing.JLabel koderiwayatkepemilikanptLabel;
    ...
    private javax.swing.JLabel tanggalakhirefektifLabel;
    private com.toedter.calendar.JDateChooser tanggalmulaiefektifField;
    private javax.swing.JLabel tanggalmulaiefektifLabel;
