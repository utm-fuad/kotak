 ...
 * @author asus
 */
public class MenuLembaga1 extends javax.swing.JPanel {  
    ...
    private String [] aikonMenuDosen = {
        "/image/lembaga/BobotNilai64.png",
        "/image/lembaga/DayaTampung64.png",
        "/image/lembaga/KerjasamaInstansi64.png",
        "/image/lembaga/RiwayatAkreditasiProdi64.png",
        "/image/lembaga/RiwayatAkreditasiPT64.png",
        "/image/lembaga/RiwayatKepemilikanPT64.png"        
    };
    ...
    class MemilihActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {             
            ...
            if (menuYgDipilih == 1) {
                homePage.panelBerikutnya("BobotNilai");
            }
            if (menuYgDipilih == 2) {
                homePage.panelBerikutnya("DayaTampung");
            }
            if (menuYgDipilih == 3) {
                homePage.panelBerikutnya("KerjasamaInstansi");
            }
            if (menuYgDipilih == 4) {
                homePage.panelBerikutnya("RiwayatAkreditasiProdi");
            }
            if (menuYgDipilih == 5) {
                homePage.panelBerikutnya("RiwayatAkreditasiPT");
            }
            if (menuYgDipilih == 6) {
                homePage.panelBerikutnya("RiwayatKepemilikanPT");
            }        }
    }
     ...
     */
    public MenuLembaga1(HomePage _homePage) {
