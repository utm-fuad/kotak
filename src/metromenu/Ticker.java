 ...
 * @author asus
 */
public class Ticker extends javax.swing.JPanel {
    ...
    public Ticker(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void inisialisasiData() {
        ...
        String [] kolom = kon.dapatkanKolom();
        tampilkanDataKeTabel(data, kolom);
    }
    
    public Ticker(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        pesanField.setText(tabel.getValueAt(row, 0).toString());
        
    }
    
    public String [] dapatkanNilaiUntukInsert() {
        kalendar = tglakhirpesan.getCalendar();
        String [] data = new String[jmlKolom];
        
        data[0] = (!pesanField.getText().equals("")?pesanField.getText():"0");
        kalendar = tglawalpesan.getCalendar();
        ...
        data[2] = (data20!=null?data20:"");
        return data;
    }
    
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                
        data[0] = pesanField.getText();
        data[2] = (!pesanField.getText().equals("")?pesanField.getText():"0");
        return data;
    }
    ...
    private void initComponents() {
        ...
        posisiLabel1 = new javax.swing.JLabel();
        posisiLabel2 = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        pesanScrollPane = new javax.swing.JScrollPane();
        pesanField = new javax.swing.JTextArea();
        tglawalpesan = new com.toedter.calendar.JDateChooser();
        tglakhirpesan = new com.toedter.calendar.JDateChooser();
        ...
        panelAtribut.setLayout(new java.awt.GridLayout(1, 2));

        panelLabel.setLayout(new java.awt.GridLayout(8, 0));

        posisiLabel.setText("Pesan :");
        panelLabel.add(posisiLabel);

        posisiLabel1.setText("Tanggal Mulai Pesan Aktif :");
        panelLabel.add(posisiLabel1);

        posisiLabel2.setText("Tanggal Akhir Pesan Aktif :");
        panelLabel.add(posisiLabel2);

        panelAtribut.add(panelLabel);

        panelTextField.setLayout(new java.awt.GridLayout(8, 0));

        pesanField.setColumns(20);
        pesanField.setRows(1);
        pesanScrollPane.setViewportView(pesanField);

        panelTextField.add(pesanScrollPane);
        panelTextField.add(tglawalpesan);
        panelTextField.add(tglakhirpesan);

        panelAtribut.add(panelTextField);
    ...
    private javax.swing.JLabel posisiLabel1;
    private javax.swing.JLabel posisiLabel2;
    private javax.swing.JTable tabel;
    private com.toedter.calendar.JDateChooser tglakhirpesan;
    private com.toedter.calendar.JDateChooser tglawalpesan;
