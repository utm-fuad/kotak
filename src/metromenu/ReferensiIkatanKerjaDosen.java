 ...
 * @author asus
 */
public class ReferensiIkatanKerjaDosen extends javax.swing.JPanel {
     ...
     */
    public ReferensiIkatanKerjaDosen() {    
        initComponents();
    }
    
    public ReferensiIkatanKerjaDosen(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_IKATAN_KERJA_DOSEN";
    ...
    public ReferensiIkatanKerjaDosen(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeikatankerjaField.setText(tabel.getValueAt(row, 0).toString());
        ikatankerjaField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeikatankerjaField.getText().equals("")?kodeikatankerjaField.getText():"X");
        data[1] = (!ikatankerjaField.getText().equals("")?ikatankerjaField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = ikatankerjaField.getText();                
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodeikatankerjaField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodeikatankerjaField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodeikatankerjaField = new javax.swing.JTextField();
        ikatankerjaField = new javax.swing.JTextField();
        ...
        kodeikatankerjaLabel.setText("Kode Ikatan Kerja:");
        ...
        panelTextField.add(kodeikatankerjaField);
    ...
    private javax.swing.JTextField ikatankerjaField;
    private javax.swing.JLabel ikatankerjaLabel;
    private javax.swing.JSplitPane jSplitPane1;
    private javax.swing.JSplitPane jSplitPane2;
    private javax.swing.JTextField kodeikatankerjaField;
