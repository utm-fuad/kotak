 ...
 * @author asus
 */
public class ReferensiJenisSMS extends javax.swing.JPanel {
     ...
     */
    public ReferensiJenisSMS() {    
        initComponents();
    }
    
    public ReferensiJenisSMS(HomePage _homePage, String _namaTabel) {
        this();
...
//        initAutoComplete();
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_JENIS_SMS";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by Kode_Jenis_SMS desc";
        kon.selectData(query);     
    ...
    public ReferensiJenisSMS(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        NamaSMSField.setText(tabel.getValueAt(row, 1).toString());   
...
//        kategoriHKI.setText(tabel.getValueAt(row, 7).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[1] = (!NamaSMSField.getText().equals("    ")?NamaSMSField.getText():"0000");
    ...
    private void initComponents() {
        ...
        kodeHKILabel.setText("Kode Jenis SMS:");
        panelLabel.add(kodeHKILabel);

        tahunpelaporanLabel.setText("Nama Jenis SMS:");
