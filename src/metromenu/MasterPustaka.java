...
import Model.ModelMasterPustaka;
import metromini.*;
 ...
 * @author asus
 */
public class MasterPustaka extends javax.swing.JPanel {
    ...
    Model.ModelMasterPustaka model;
    ...
    public MasterPustaka(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodepustakaptField.setText(tabel.getValueAt(row, 0).toString());
        ...
        jmljudulpustakaField.setText(tabel.getValueAt(row, 6).toString());
        jmljudulpustakadigunakanField.setText(tabel.getValueAt(row, 7).toString());
        jenispustakaField.setText(tabel.getValueAt(row, 8).toString());
        namapustakaField.setText(tabel.getValueAt(row, 9).toString());
        tahunterbitpustakaField.setText(tabel.getValueAt(row, 10).toString());
        fungsipustakaField.setText(tabel.getValueAt(row, 11).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = kodepustakaptField.getText();
        ...
        data[6] = (!jmljudulpustakaField.getText().equals("")?jmljudulpustakaField.getText():"0");
        data[7] = (!jmljudulpustakadigunakanField.getText().equals("")?jmljudulpustakadigunakanField.getText():"0");
        data[8] = jenispustakaField.getText();
        data[9] = namapustakaField.getText();
        data[10] = (!tahunterbitpustakaField.getText().equals("    ")?tahunterbitpustakaField.getText():"0");        
        data[11] = fungsipustakaField.getText();
        data[12] = "" + idlogaudit;
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[5] = jmljudulpustakaField.getText();
        data[6] = jmljudulpustakadigunakanField.getText();
        data[7] = jenispustakaField.getText();
        data[8] = namapustakaField.getText();
        data[9] = tahunterbitpustakaField.getText();
        data[10] = fungsipustakaField.getText();
        data[11] = "" + idlogaudit;
        data[12] = kodepustakaptField.getText();
        return data;
    }
    ...
    private void initComponents() {
        ...
        namapustakaLabel = new javax.swing.JLabel();
        tahunterbitpustakaLabel = new javax.swing.JLabel();
        fungsipustakaLabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        kodepustakaptField = new javax.swing.JFormattedTextField();
        ...
        jmljudulpustakaField = new javax.swing.JFormattedTextField();
        jmljudulpustakadigunakanField = new javax.swing.JFormattedTextField();
        jenispustakaField = new javax.swing.JTextField();
        namapustakaField = new javax.swing.JTextField();
        tahunterbitpustakaField = new javax.swing.JFormattedTextField();
        fungsipustakaField = new javax.swing.JTextField();
        ...
        jmljudulpustakaLabel.setText("Jml Judul Pustaka:");
        panelLabel.add(jmljudulpustakaLabel);

        jmljudulpustakadigunakanLabel.setText("Jml Judul Pustaka Digunakan:");
        panelLabel.add(jmljudulpustakadigunakanLabel);

        jenispustakaLabel.setText("Jenis Pustaka:");
        panelLabel.add(jenispustakaLabel);

        namapustakaLabel.setText("Nama Pustaka:");
        panelLabel.add(namapustakaLabel);

        tahunterbitpustakaLabel.setText("Tahun Terbit Pustaka:");
        panelLabel.add(tahunterbitpustakaLabel);

        fungsipustakaLabel.setText("Fungsi Pustaka:");
        panelLabel.add(fungsipustakaLabel);
        ...
        kodepustakaptField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("##########"))));
        panelTextField.add(kodepustakaptField);
        ...
        jmljudulpustakaField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#######"))));
        panelTextField.add(jmljudulpustakaField);

        jmljudulpustakadigunakanField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        panelTextField.add(jmljudulpustakadigunakanField);
        panelTextField.add(jenispustakaField);
        panelTextField.add(namapustakaField);

        try {
            tahunterbitpustakaField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        panelTextField.add(tahunterbitpustakaField);
        panelTextField.add(fungsipustakaField);
...
//            dapatkanNilaiUntukInsert() );
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        "\"Jml_judul_pustaka\"=?, " +
        "\"Jml_judul_pustaka_digunakan\"=?, " +
        "\"Jenis_pustaka\"=?, " +
        "\"Nama_pustaka\" = ?, " +
        "\"Tahun_terbit_pustaka\" = ?, " +
        "\"Fungsi_pustaka\" = ?, " +
        "\"ID_log_audit\"=? " +
        " WHERE \"Kode_pustaka_pt\"=? ";
//        int hasil = kon.insertUpdateDeleteData(query,
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JTextField fungsipustakaField;
    private javax.swing.JLabel fungsipustakaLabel;
    private javax.swing.JScrollPane gulungPanelAtribut;
    private javax.swing.JScrollPane gulungTabel;
    private javax.swing.JSplitPane jSplitPane1;
    private javax.swing.JSplitPane jSplitPane2;
    private javax.swing.JTextField jenispustakaField;
    private javax.swing.JLabel jenispustakaLabel;
    private javax.swing.JFormattedTextField jmljudulpustakaField;
    private javax.swing.JLabel jmljudulpustakaLabel;
    private javax.swing.JFormattedTextField jmljudulpustakadigunakanField;
    ...
    private javax.swing.JFormattedTextField kodepustakaptField;
    private javax.swing.JLabel kodepustakaptLabel;
    private javax.swing.JTextField namapustakaField;
    private javax.swing.JLabel namapustakaLabel;
    ...
    private javax.swing.JFormattedTextField tahunterbitpustakaField;
    private javax.swing.JLabel tahunterbitpustakaLabel;
