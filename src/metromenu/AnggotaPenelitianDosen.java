...
import Model.ModelAnggotaPenelitianDosen;
import metromini.*;
 ...
 * @author asus
 */
public class AnggotaPenelitianDosen extends javax.swing.JPanel {
    ...
    Model.ModelAnggotaPenelitianDosen model;
    private int kodeanggotapenelitiandosen, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public AnggotaPenelitianDosen() {    
        initComponents();
    }
    
    public AnggotaPenelitianDosen(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelAnggotaPenelitianDosen();
    ...
    private void initPKAutoIncrement() {
        query = "select \"Kode_anggota_penelitian\" " +
                " from pdpt_dev.\"TRAN_ANGGOTA_PENELITIAN_DOSEN\" " +
                " order by \"Kode_anggota_penelitian\" desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        try{
        kodeanggotapenelitiandosen = Integer.parseInt(data[0][0]);
        }catch(Exception e){
            kodeanggotapenelitiandosen=0;
        }
        kodeanggotapenelitiandosen++;
        System.out.println("kodeanggotapenelitiandosen: " + kodeanggotapenelitiandosen);
    }
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_ANGGOTA_PENELITIAN_DOSEN\"";
    ...
    public AnggotaPenelitianDosen(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodeanggotapenelitianField.setText("" + kodeanggotapenelitiandosen);
        kodepublikasidosentetap.setText("");
        nidnField.setText("");
        IDlogauditField.setText("");
        UUIDField.setText("");
        kodeanggotapenelitianField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeanggotapenelitianField.setText(tabel.getValueAt(row, 0).toString());
        kodepublikasidosentetap.setText(tabel.getValueAt(row, 1).toString());        
        nidnField.setText(tabel.getValueAt(row, 2).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeanggotapenelitianField.getText().equals("")?kodeanggotapenelitianField.getText():"0");
        ...
        data[2] = (!nidnField.getText().equals("          ")?nidnField.getText():"0000000000");
        data[3] = "" + idlogaudit;
        data[4] = "" + UUIDField.getText();
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[1] = nidnField.getText();
        data[2] = "" + idlogaudit;
        data[4] = kodeanggotapenelitianField.getText();
    ...
    public String[] dapatkanNilaiUntukDelete(){
        ...
        data[0] = kodeanggotapenelitianField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodeanggotapenelitianLabel = new javax.swing.JLabel();
        ...
        kodeanggotapenelitianField = new javax.swing.JFormattedTextField();
        ...
        kodeanggotapenelitianLabel.setText("Kode Anggota Penelitian:");
        panelLabel.add(kodeanggotapenelitianLabel);
        ...
        kodeanggotapenelitianField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodeanggotapenelitianField);
...
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JFormattedTextField kodeanggotapenelitianField;
    private javax.swing.JLabel kodeanggotapenelitianLabel;
