 ...
 * @author asus
 */
public class ReferensiDirektoratJenderal extends javax.swing.JPanel {
    ...
    private int kodedirektoratjenderal, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiDirektoratJenderal() {    
        initComponents();
    }
    
    public ReferensiDirektoratJenderal(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_direktorat_jenderal " +
                " from TREF_DIREKTORAT_JENDERAL " +
                " order by Kode_direktorat_jenderal desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodedirektoratjenderal = Integer.parseInt(data[0][0]);
        kodedirektoratjenderal++;
        System.out.println("KodeKopertis: " + kodedirektoratjenderal);
    }
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_DIREKTORAT_JENDERAL";
    ...
    public ReferensiDirektoratJenderal(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodedirektoratjenderalField.setText("" + kodedirektoratjenderal);
        namadirektoratjenderalField.setText("");
        singkatanField.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        
        namadirektoratjenderalField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodedirektoratjenderalField.setText(tabel.getValueAt(row, 0).toString());
        namadirektoratjenderalField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodedirektoratjenderalField.getText().equals("")?kodedirektoratjenderalField.getText():"0");
        data[1] = (!namadirektoratjenderalField.getText().equals("")?namadirektoratjenderalField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namadirektoratjenderalField.getText();                
        data[1] = singkatanField.getText();
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodedirektoratjenderalField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodedirektoratjenderalField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namadirektoratjenderalLabel = new javax.swing.JLabel();
        ...
        kodedirektoratjenderalField = new javax.swing.JFormattedTextField();
        namadirektoratjenderalField = new javax.swing.JTextField();
        ...
        namadirektoratjenderalLabel.setText("Nama Direktorat Jenderal:");
        panelLabel.add(namadirektoratjenderalLabel);
        ...
        kodedirektoratjenderalField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodedirektoratjenderalField);
        panelTextField.add(namadirektoratjenderalField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET Nama_direktorat_jenderal=?, " +
        "Singkatan=?, " +        
        "Tgl_mulai_efektif=?, " +
        "Tgl_akhir_efektif=?, " +
        "ID_log_audit=? " +
        " WHERE Kode_direktorat_jenderal=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JFormattedTextField kodedirektoratjenderalField;
    private javax.swing.JLabel kodedirektoratjenderalLabel;
    private javax.swing.JTextField namadirektoratjenderalField;
    private javax.swing.JLabel namadirektoratjenderalLabel;
