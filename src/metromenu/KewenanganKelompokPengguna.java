...
import Model.ModelKewenanganKelompokPengguna;
import metromini.*;
 ...
 * @author asus
 */
public class KewenanganKelompokPengguna extends javax.swing.JPanel {
    ...
    private JTextField koderoleuser;  
    private koneksi.KompletTextFieldCombo kompletTextFieldCombo1;
    private JTextField kodemenu;  
    private koneksi.KompletTextFieldCombo kompletTextFieldCombo2;
    Model.ModelKewenanganKelompokPengguna model;
    private int kodegroupuserpriviledge, idlogaudit;
    private String kueri;
    /**
     * Creates new form PanelHalaman1
     */
    public KewenanganKelompokPengguna() {    
        initComponents();
    }
    
    public KewenanganKelompokPengguna(HomePage _homePage, String _namaTabel) {
        this();
        ...
        model = new ModelKewenanganKelompokPengguna();
        inisialisasiData();
        initAutoComplete();
    }
    
    private void initPKAutoIncrement() {
        query = "select \"Kode_group_user_priviledge\" " +
                " from pdpt_dev.\"TRAN_GROUP_USER_PRIVILEDGE\" " +
                " order by \"Kode_group_user_priviledge\" desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        if (data[0][0] == null) {
            kodegroupuserpriviledge = 1;
        } else {
            kodegroupuserpriviledge = Integer.parseInt(data[0][0]);
            kodegroupuserpriviledge++;
        }        
        System.out.println("kodegroupuserpriviledge: " + kodegroupuserpriviledge);
    }
    ...
    private void initAutoComplete() {
        kompletTextFieldCombo1 = new KompletTextFieldCombo(kon, 
                koderoleuserField, koderoleuser);        
        query = "select \"Kode_role_user\", \"Nama_role\" from pdpt_dev.\"TREF_ROLE_USER\""; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(query);        
        koderoleuser = kompletTextFieldCombo1.dapatkanTextField();
        koderoleuserField = kompletTextFieldCombo1.dapatkanComboBox();        
        
        kompletTextFieldCombo2 = new KompletTextFieldCombo(kon, 
                kodemenuField, kodemenu);        
        query = "select \"Kode_menu\", \"Nama_menu\" from pdpt_dev.\"TREF_MENU\""; 
        kompletTextFieldCombo2.initDataUtkAutoComplete(query);        
        kodemenu = kompletTextFieldCombo2.dapatkanTextField();
        kodemenuField = kompletTextFieldCombo2.dapatkanComboBox();        
    }
    
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_GROUP_USER_PRIVILEDGE\"";
    ...
    public KewenanganKelompokPengguna(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodegroupuserField.setText("" + kodegroupuserpriviledge);
        koderoleuser.setText("");
        kodemenu.setText("");
        
        koderoleuser.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodegroupuserField.setText(tabel.getValueAt(row, 0).toString());
        koderoleuser.setText(tabel.getValueAt(row, 1).toString());        
        kodemenu.setText(tabel.getValueAt(row, 2).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodegroupuserField.getText().equals("")?kodegroupuserField.getText():"0");
        
        String datakoderoleusermentah = koderoleuser.getText();
        ...
        String datakodemenumentah = kodemenu.getText();
        System.out.println("data kodemenu mentah: " + datakodemenumentah);
        String [] datakodemenu = datakodemenumentah.split(" ");
        System.out.println("data kodemenu yg dipilih: " + datakodemenu[0]);
        data[2] = datakodemenu[0];
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        String [] datakodemenu = datakodemenumentah.split(" ");
        System.out.println("data kodemenu yg dipilih: " + datakodemenu[0]);
        data[1] = datakodemenu[0];
        
        data[2] = "" + idlogaudit;
        data[3] = (!kodegroupuserField.getText().equals("")?kodegroupuserField.getText():"0");
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodegroupuserField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namatenagaahliLabel = new javax.swing.JLabel();
        posisiLabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        kodegroupuserField = new javax.swing.JFormattedTextField();
        koderoleuserField = new javax.swing.JComboBox();
        kodemenuField = new javax.swing.JComboBox();
        ...
        kodetenagaahliLabel.setText("Kode Group User Priviledge:");
        panelLabel.add(kodetenagaahliLabel);

        namatenagaahliLabel.setText("Kode Role User:");
        panelLabel.add(namatenagaahliLabel);

        posisiLabel.setText("Kode Menu:");
        panelLabel.add(posisiLabel);
        ...
        kodegroupuserField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodegroupuserField);

        panelTextField.add(koderoleuserField);
...
//            dapatkanNilaiUntukInsert() );
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        "\"Kode_menu\"=?, " +
        "\"ID_log_audit\"=? "+
        " WHERE \"Kode_group_user_priviledge\"=? ";
//        int hasil = kon.insertUpdateDeleteData(query,
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JFormattedTextField kodegroupuserField;
    private javax.swing.JComboBox kodemenuField;
    private javax.swing.JComboBox koderoleuserField;
    private javax.swing.JLabel kodetenagaahliLabel;
    private javax.swing.JLabel namatenagaahliLabel;
