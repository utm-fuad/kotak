...
import Model.ModelKerjasamaPTLN;
import metromini.*;
 ...
 * @author asus
 */
public class MasterKerjasamaPTLN extends javax.swing.JPanel {
    ...
    Model.ModelKerjasamaPTLN model;
    private int kodekerjasamaptln, idlogaudit;
    private String kueri,kodept;

    /**
     * Creates new form PanelHalaman1
     */
    public MasterKerjasamaPTLN() {    
        initComponents();
    }
    
    public MasterKerjasamaPTLN(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelKerjasamaPTLN();
    ...
    private void initPKAutoIncrement() {
        query = "select \"Kode_kerjasama_PTLN\" " +
                " from pdpt_dev.\"TMST_KERJASAMA_PT_LN\" " +
                " order by \"Kode_kerjasama_PTLN\" desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodekerjasamaptln = Integer.parseInt(data[0][0]);
        kodekerjasamaptln++;
        System.out.println("kodekerjasamaptln: " + kodekerjasamaptln);
    }
    ...
    private void inisialisasiData() {
        ...
        query = "select * from pdpt_dev.\"TMST_KERJASAMA_PT_LN \"";
        kon.selectData(query);     
    ...
    public MasterKerjasamaPTLN(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        ...
        kodeperguruantinggiasingField.setText("");
        kodekerjasamaPTLNField.setText("" + kodekerjasamaptln);
        uraianbentukkerjasamaField.setText("");        
    ...
    private void initComponents() {
        ...
        kodeperguruantinggiasingLabel = new javax.swing.JLabel();
        kodekerjasamaPTLNLabel = new javax.swing.JLabel();
        uraianbentukkerjasamaLabel = new javax.swing.JLabel();
        ...
        kodeperguruantinggiasingField = new javax.swing.JFormattedTextField();
        kodekerjasamaPTLNField = new javax.swing.JFormattedTextField();
        uraianbentukkerjasamaScrollPane = new javax.swing.JScrollPane();
        uraianbentukkerjasamaField = new javax.swing.JTextArea();
        ...
        kodeperguruantinggiasingLabel.setText("Kode Perguruan Tinggi Asing:");
        panelLabel.add(kodeperguruantinggiasingLabel);

        kodekerjasamaPTLNLabel.setText("Kode Kerjasama PTLN:");
        panelLabel.add(kodekerjasamaPTLNLabel);

        uraianbentukkerjasamaLabel.setText("Uraian Bentuk Kerjasama:");
        panelLabel.add(uraianbentukkerjasamaLabel);
        ...
        try {
            kodeperguruantinggiasingField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("######")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        panelTextField.add(kodeperguruantinggiasingField);

        kodekerjasamaPTLNField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("######"))));
        panelTextField.add(kodekerjasamaPTLNField);

        uraianbentukkerjasamaField.setColumns(20);
        uraianbentukkerjasamaField.setRows(1);
        uraianbentukkerjasamaScrollPane.setViewportView(uraianbentukkerjasamaField);

        panelTextField.add(uraianbentukkerjasamaScrollPane);
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[1] = kodeperguruantinggiasingField.getText();
        data[2] = kodekerjasamaPTLNField.getText();
        data[3] = uraianbentukkerjasamaField.getText();
        data[4] = "" + idlogaudit;
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[0] = kodeperguruantinggiField.getText();
        data[1] = kodeperguruantinggiasingField.getText();        
        data[2] = uraianbentukkerjasamaField.getText();
        data[3] = "" + idlogaudit;
        
        data[4] = kodekerjasamaPTLNField.getText();        
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodekerjasamaPTLNField.getText();        
        return data;   
    }
    ...
    private void buttonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonInsertActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();
        String query = "insert into pdpt_dev.\"TMST_KERJASAMA_PT_LN\" " +
        " values(?,?,?,?,?) ";
...
//            dapatkanNilaiUntukInsert() );
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();
        String query = "update pdpt_dev.\"TMST_KERJASAMA_PT_LN\" " +
        " SET " + 
        " \"Kode_perguruan_tinggi\"=?, " +
        " \"Kode_perguruan_tinggi_asing\"=?, " +         
        " \"Uraian_bentuk_kerjasama\"=?, " +
        " \"ID_log_audit\"=? " +
        " WHERE " +         
        " \"Kode_kerjasama_PTLN\"=? ";
//        int hasil = kon.insertUpdateDeleteData(query,
//            dapatkanNilaiUntukUpdate() );
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();
        String query = "delete from pdpt_dev.\"TMST_KERJASAMA_PT_LN\" " +
        " WHERE " +         
        " \"Kode_kerjasama_PTLN\"=? ";
    ...
    private void tampilkanData(int row) {
        ...
        kodeperguruantinggiasingField.setText(tabel.getValueAt(row, 1).toString());
        kodekerjasamaPTLNField.setText(tabel.getValueAt(row, 2).toString());
        uraianbentukkerjasamaField.setText(tabel.getValueAt(row, 3).toString());
    ...
    private javax.swing.JFormattedTextField kodekerjasamaPTLNField;
    private javax.swing.JLabel kodekerjasamaPTLNLabel;
    private javax.swing.JFormattedTextField kodeperguruantinggiField;
    private javax.swing.JLabel kodeperguruantinggiLabel;
    private javax.swing.JFormattedTextField kodeperguruantinggiasingField;
    private javax.swing.JLabel kodeperguruantinggiasingLabel;
    ...
    private javax.swing.JTextArea uraianbentukkerjasamaField;
    private javax.swing.JLabel uraianbentukkerjasamaLabel;
    private javax.swing.JScrollPane uraianbentukkerjasamaScrollPane;
