 ...
 * @author asus
 */
public class ReferensiDirektorat extends javax.swing.JPanel {
    ...
    private int kodedirektorat, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiDirektorat() {    
        initComponents();
    }
    
    public ReferensiDirektorat(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_direktorat " +
                " from TREF_DIREKTORAT " +
                " order by Kode_direktorat desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodedirektorat = Integer.parseInt(data[0][0]);
        kodedirektorat++;
        System.out.println("KodeKopertis: " + kodedirektorat);
    }
    ...
    private void initAutoComplete() {        
        ...
        query = "select Kode_direktorat_jenderal, Nama_direktorat_jenderal " +
                " from TREF_DIREKTORAT_JENDERAL"; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(query);        
        kodedirektoratjenderal = kompletTextFieldCombo1.dapatkanTextField();
        kodedirektoratJenderalField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    
    private void inisialisasiData() {
        namaTabel = "TREF_DIREKTORAT";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by Kode_direktorat desc";
        kon.selectData(query);     
    ...
    public ReferensiDirektorat(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodedirektoratField.setText(tabel.getValueAt(row, 0).toString());        
        kodedirektoratjenderal.setText(tabel.getValueAt(row, 1).toString());        
        namadirektoratField.setText(tabel.getValueAt(row, 2).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodedirektoratField.getText().equals("")?kodedirektoratField.getText():"0");
        ...
        data[1] = datakodedirektoratjenderal[0];
        
        data[2] = (!namadirektoratField.getText().equals("")?namadirektoratField.getText():"X");
        data[3] = (!singkatanField.getText().equals("")?singkatanField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = kodedirektoratjenderal.getText();                
        data[1] = namadirektoratField.getText();                
        data[2] = singkatanField.getText();                                
        ...
        data[4] = (data25!=null?data25:"");
        
        data[5] = "" + idlogaudit;
        data[6] = kodedirektoratField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodedirektoratField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodedirektoratjenderalLabel = new javax.swing.JLabel();
        namadirektoratLabel = new javax.swing.JLabel();
        ...
        kodedirektoratField = new javax.swing.JFormattedTextField();
        kodedirektoratJenderalField = new javax.swing.JComboBox();
        namadirektoratField = new javax.swing.JTextField();
        ...
        kodedirektoratjenderalLabel.setText("Kode Direktorat Jenderal:");
        panelLabel.add(kodedirektoratjenderalLabel);

        namadirektoratLabel.setText("Nama Direktorat:");
        panelLabel.add(namadirektoratLabel);
        ...
        kodedirektoratField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodedirektoratField);

        panelTextField.add(kodedirektoratJenderalField);
        panelTextField.add(namadirektoratField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET Kode_direktorat_jenderal=?, " + 
        "Nama_direktorat=?, " +        
        "Singkatan=?, " +                        
        "Tgl_mulai_efektif=?, " +
        "Tgl_akhir_efektif=?, " +        
        "ID_log_audit=? " +
        " WHERE Kode_direktorat=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JFormattedTextField kodedirektoratField;
    private javax.swing.JComboBox kodedirektoratJenderalField;
    private javax.swing.JLabel kodedirektoratLabel;
    private javax.swing.JLabel kodedirektoratjenderalLabel;
    private javax.swing.JTextField namadirektoratField;
    private javax.swing.JLabel namadirektoratLabel;
