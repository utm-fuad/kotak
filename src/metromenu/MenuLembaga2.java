 ...
 * @author asus
 */
public class MenuLembaga2 extends javax.swing.JPanel {  
    ...
    private String [] aikonMenuDosen = {
        "/image/lembaga/RiwayatSKProdi64.png",
        "/image/lembaga/RiwayatSKPT64.png",
        "/image/lembaga/ValidasiPT64.png",
        "/image/lembaga/MasterProdi64.png",
        "/image/lembaga/MasterJurusan64.png",
        "/image/lembaga/MasterFakultas64.png"
    };
    ...
    class MemilihActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {             
            ...
            if (menuYgDipilih == 1) {
                homePage.panelBerikutnya("RiwayatSKProdi");
            }
            if (menuYgDipilih == 2) {
                homePage.panelBerikutnya("RiwayatSKPT");
            }
            if (menuYgDipilih == 3) {
                homePage.panelBerikutnya("ValidasiPT");
            }
            if (menuYgDipilih == 4) {
                homePage.panelBerikutnya("MasterProdi");
            }
            if (menuYgDipilih == 5) {
                homePage.panelBerikutnya("MasterJurusan");
            }
            if (menuYgDipilih == 6) {
                homePage.panelBerikutnya("MasterFakultas");
            }
        }
    }
     ...
     */
    public MenuLembaga2(HomePage _homePage) {
    ...
    private void buttonMenuNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenuNextActionPerformed
        ...
        homePage.panelBerikutnya("Lembaga3");
