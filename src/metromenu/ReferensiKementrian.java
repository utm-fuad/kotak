 ...
 * @author asus
 */
public class ReferensiKementrian extends javax.swing.JPanel {
    ...
    private int kodekementrian, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiKementrian() {    
        initComponents();
    }
    
    public ReferensiKementrian(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_kementrian " +
                " from TREF_KEMENTRIAN " +
                " order by Kode_kementrian desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodekementrian = Integer.parseInt(data[0][0]);
        kodekementrian++;
        System.out.println("KodeKopertis: " + kodekementrian);
    }
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_KEMENTRIAN";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by Kode_kementrian desc";
        kon.selectData(query);     
    ...
    public ReferensiKementrian(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodekementrianField.setText(tabel.getValueAt(row, 0).toString());
        namakementrianField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodekementrianField.getText().equals("")?kodekementrianField.getText():"0");
        data[1] = (!namakementrianField.getText().equals("")?namakementrianField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namakementrianField.getText();                
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodekementrianField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodekementrianField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namakementrianLabel = new javax.swing.JLabel();
        ...
        kodekementrianField = new javax.swing.JFormattedTextField();
        namakementrianField = new javax.swing.JTextField();
        ...
        namakementrianLabel.setText("Nama Kementrian:");
        panelLabel.add(namakementrianLabel);
        ...
        kodekementrianField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodekementrianField);
        panelTextField.add(namakementrianField);
    ...
    private javax.swing.JFormattedTextField kodekementrianField;
    private javax.swing.JLabel kodekementrianLabel;
    private javax.swing.JTextField namakementrianField;
    private javax.swing.JLabel namakementrianLabel;
