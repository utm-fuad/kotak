 ...
 * @author asus
 */
public class ReferensiFungsiLab extends javax.swing.JPanel {
     ...
     */
    public ReferensiFungsiLab() {    
        initComponents();
    }
    
    public ReferensiFungsiLab(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initIDLogAudit() {
        /*tdk butuh ini karena tipe data yg digunakan char(1)
    ...
    public ReferensiFungsiLab(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        kodefungsilabField.setText("");
        fungsilabField.setText("");
        IDlogauditField.setText("");
        
        kodefungsilabField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodefungsilabField.setText(tabel.getValueAt(row, 0).toString());
        fungsilabField.setText(tabel.getValueAt(row, 1).toString());
        //IDlogauditField.setText(tabel.getValueAt(row, 2).toString());
    }
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodefungsilabField.getText().equals("")?kodefungsilabField.getText():"X");
        data[1] = (!fungsilabField.getText().equals("")?fungsilabField.getText():"X");
        data[2] = "" + idlogaudit;
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = fungsilabField.getText();                
        data[1] = "" + idlogaudit;
        data[2] = kodefungsilabField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodefungsilabField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodefungsilabLabel = new javax.swing.JLabel();
        fungsilabLabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        kodefungsilabField = new javax.swing.JTextField();
        fungsilabField = new javax.swing.JTextField();
        ...
        kodefungsilabLabel.setText("Kode Fungsi Lab:");
        panelLabel.add(kodefungsilabLabel);

        fungsilabLabel.setText("Fungsi Lab:");
        panelLabel.add(fungsilabLabel);
        ...
        panelTextField.add(kodefungsilabField);
        panelTextField.add(fungsilabField);
    ...
    private javax.swing.JTextField fungsilabField;
    private javax.swing.JLabel fungsilabLabel;
    private javax.swing.JScrollPane gulungPanelAtribut;
    private javax.swing.JScrollPane gulungTabel;
    private javax.swing.JSplitPane jSplitPane1;
    private javax.swing.JSplitPane jSplitPane2;
    private javax.swing.JTextField kodefungsilabField;
    private javax.swing.JLabel kodefungsilabLabel;
