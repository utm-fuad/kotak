 ...
 * @author asus
 */
public class ReferensiProvinsi2 extends javax.swing.JPanel {
     ...
     */
    public ReferensiProvinsi2() {    
        initComponents();
    }
    
    public ReferensiProvinsi2(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initAutoComplete() {        
        ...
        kodenegara = kompletTextFieldCombo1.dapatkanTextField();
        kodenegaraField = kompletTextFieldCombo1.dapatkanComboBox();
        
        kompletTextFieldCombo2 = new KompletTextFieldCombo(kon, 
                kodepulauField, kodepulau);        
        query = "select Kode_pulau, Nama_pulau " +
                " from TREF_PULAU"; 
        kompletTextFieldCombo2.initDataUtkAutoComplete(query);        
        kodepulau = kompletTextFieldCombo2.dapatkanTextField();
        kodepulauField = kompletTextFieldCombo2.dapatkanComboBox();
    }
    
    private void inisialisasiData() {
        namaTabel = "TREF_PROVINSI";
    ...
    public ReferensiProvinsi2(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        ...
        kodeprovinsiField.setText("" + kodeprovinsi);        
        namaprovinsiField.setText("");
        kodenegara.setText("");
        kodepulau.setText("");
        ...
        namaprovinsiField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeprovinsiField.setText(tabel.getValueAt(row, 0).toString());        
        namaprovinsiField.setText(tabel.getValueAt(row, 1).toString());
        kodenegara.setText(tabel.getValueAt(row, 2).toString());
        ...
        kodepulau.setText(tabel.getValueAt(row, 5).toString());        
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeprovinsiField.getText().equals("")?kodeprovinsiField.getText():"0");
        data[1] = (!namaprovinsiField.getText().equals("")?namaprovinsiField.getText():"X");
        
        String datakodenegaramentah = kodenegara.getText();
        System.out.println("data kodenegara mentah: " + datakodenegaramentah);
        String [] datakodenegara = datakodenegaramentah.split(" ");
        System.out.println("data kodenegara yg dipilih: " + datakodenegara[0]);
        data[2] = datakodenegara[0];
        ...
        String datakodepulaumentah = kodepulau.getText();
        System.out.println("data kodepulau mentah: " + datakodepulaumentah);
        String [] datakodepulau = datakodepulaumentah.split(" ");
        System.out.println("data kodepulau yg dipilih: " + datakodepulau[0]);
        data[5] = datakodepulau[0];
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namaprovinsiField.getText();                
        data[1] = kodenegara.getText();                                
        ...
        data[4] = kodepulau.getText();
        
        data[5] = "" + idlogaudit;
        data[6] = kodeprovinsiField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodeprovinsiField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namaprovinsiLabel = new javax.swing.JLabel();
        ...
        kodeprovinsiField = new javax.swing.JFormattedTextField();
        namaprovinsiField = new javax.swing.JTextField();
        kodenegaraField = new javax.swing.JComboBox();
        kodepulauField = new javax.swing.JComboBox();
        ...
        namaprovinsiLabel.setText("Nama Provinsi:");
        panelLabel.add(namaprovinsiLabel);

        kodenegaraLabel.setText("Kode Negara:");
        panelLabel.add(kodenegaraLabel);

        kodepulauLabel.setText("Kode Pulau:");
        ...
        kodeprovinsiField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodeprovinsiField);
        panelTextField.add(namaprovinsiField);

        panelTextField.add(kodenegaraField);

        panelTextField.add(kodepulauField);
    ...
    private javax.swing.JFormattedTextField kodeprovinsiField;
    private javax.swing.JLabel kodeprovinsiLabel;
    private javax.swing.JComboBox kodepulauField;
    private javax.swing.JLabel kodepulauLabel;
    private javax.swing.JTextField namaprovinsiField;
    private javax.swing.JLabel namaprovinsiLabel;
