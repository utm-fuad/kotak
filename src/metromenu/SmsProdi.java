 ...
 * @author asus
 */
public class SmsProdi extends javax.swing.JPanel {
    ...
    public SmsProdi(HomePage _homePage, String _namaTabel) {
        this();
...
//        initAutoComplete();
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TMST_SMS_PRODI\"";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by \"Kode_SMS\" desc";
        kon.selectData(query);     
    ...
    public SmsProdi(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeSMSField.setText(tabel.getValueAt(row, 0).toString());
        KodePTField.setText(tabel.getValueAt(row, 1).toString());        
        KodeProdiField.setText(tabel.getValueAt(row, 2).toString());
...
//        kategoriHKI.setText(tabel.getValueAt(row, 7).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeSMSField.getText().equals("")?kodeSMSField.getText():"0");
        data[1] = (!KodePTField.getText().equals("    ")?KodePTField.getText():"0000");
        data[2] = (!KodeProdiField.getText().equals(" ")?KodeProdiField.getText():"0");
    ...
    private void initComponents() {
        ...
        kodeSMSField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
    ...
    private void buttonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonInsertActionPerformed
        ...
        if (hasil == 1) {
            query = "select * from " + namaTabel + " order by \"Kode_HKI\" desc";
            kon.selectData(query);
