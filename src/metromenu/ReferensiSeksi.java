 ...
 * @author asus
 */
public class ReferensiSeksi extends javax.swing.JPanel {
     ...
     */
    public ReferensiSeksi() {    
        initComponents();
    }
    
    public ReferensiSeksi(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initAutoComplete() {        
        ...
        kodebagian = kompletTextFieldCombo1.dapatkanTextField();
        kodebagianField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    
    private void inisialisasiData() {
        namaTabel = "TREF_SEKSI";
    ...
    public ReferensiSeksi(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeseksiField.setText(tabel.getValueAt(row, 0).toString());
        kodebagian.setText(tabel.getValueAt(row, 1).toString());
        namaseksiField.setText(tabel.getValueAt(row, 2).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeseksiField.getText().equals("")?kodeseksiField.getText():"0");
        ...
        data[1] = datakodebagian[0];
        
        data[2] = (!namaseksiField.getText().equals("")?namaseksiField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodeseksiField.getText();
        data[6] = kodebagian.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[2];
        data[0] = kodeseksiField.getText();
        data[1] = kodebagian.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namaseksiLabel = new javax.swing.JLabel();
        ...
        kodeseksiField = new javax.swing.JFormattedTextField();
        kodebagianField = new javax.swing.JComboBox();
        namaseksiField = new javax.swing.JTextField();
        ...
        namaseksiLabel.setText("Nama Seksi:");
        panelLabel.add(namaseksiLabel);
        ...
        kodeseksiField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodeseksiField);

        panelTextField.add(kodebagianField);
        panelTextField.add(namaseksiField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        "Tgl_akhir_efektif=?, " +
        "ID_log_audit=? " +
        " WHERE Kode_seksi=? AND " + "Kode_bagian=?";
    ...
    private javax.swing.JFormattedTextField kodeseksiField;
    private javax.swing.JLabel kodeseksiLabel;
    private javax.swing.JTextField namaseksiField;
    private javax.swing.JLabel namaseksiLabel;
