 ...
 * @author asus
 */
public class ReferensiBeasiswa extends javax.swing.JPanel {
    ...
    private int kodebeasiswa, idlogaudit;
     ...
     */
    public ReferensiBeasiswa() {    
        initComponents();
    }
    
    public ReferensiBeasiswa(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_beasiswa " +
                " from TREF_BEASISWA " +
                " order by Kode_beasiswa desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodebeasiswa = Integer.parseInt(data[0][0]);
        kodebeasiswa++;
        System.out.println("KodeBeasiswa: " + kodebeasiswa);        
    }
    ...
    private void initAutoComplete() {   
        ...
        String [][] datanya1 = {{"1","Pemerintah"},
            {"2","Swasta"},{"3","Perguruan Tinggi"},
            {"4","Lain-lain (Luar Negeri, Pemda, dll)"}
        }; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(datanya1);
        provider = kompletTextFieldCombo1.dapatkanTextField();
        providerField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_BEASISWA";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by Kode_beasiswa desc";
        kon.selectData(query);     
    ...
    public ReferensiBeasiswa(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodebeasiswaField.setText("" + kodebeasiswa);
        jenisbeasiswaField.setText("");
        provider.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        
        jenisbeasiswaField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodebeasiswaField.setText(tabel.getValueAt(row, 0).toString());
        jenisbeasiswaField.setText(tabel.getValueAt(row, 1).toString());
        provider.setText(tabel.getValueAt(row, 2).toString());        
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodebeasiswaField.getText().equals("")?kodebeasiswaField.getText():"X");
        data[1] = (!jenisbeasiswaField.getText().equals("")?jenisbeasiswaField.getText():"X");
        
        String dataprovidermentah = provider.getText();
        System.out.println("data provider mentah: " + dataprovidermentah);
        String [] dataprovider = dataprovidermentah.split(" ");
        System.out.println("data provider yg dipilih: " + dataprovider[0]);
        data[2] = dataprovider[0];
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = jenisbeasiswaField.getText();                
        data[1] = provider.getText();
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodebeasiswaField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodebeasiswaField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodeikatankerjaLabel = new javax.swing.JLabel();
        ...
        kodebeasiswaField = new javax.swing.JFormattedTextField();
        jenisbeasiswaField = new javax.swing.JTextField();
        providerField = new javax.swing.JComboBox();
        ...
        kodeikatankerjaLabel.setText("Kode Beasiswa:");
        panelLabel.add(kodeikatankerjaLabel);

        ikatankerjaLabel.setText("Jenis Beasiswa:");
        panelLabel.add(ikatankerjaLabel);

        deskripsiLabel.setText("Provider:");
        ...
        kodebeasiswaField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodebeasiswaField);
        panelTextField.add(jenisbeasiswaField);

        panelTextField.add(providerField);
    ...
    private javax.swing.JTextField jenisbeasiswaField;
    private javax.swing.JFormattedTextField kodebeasiswaField;
    private javax.swing.JLabel kodeikatankerjaLabel;
    ...
    private javax.swing.JComboBox providerField;
