 ...
 * @author asus
 */
public class MenuReferensi3 extends javax.swing.JPanel {  
    ...
    private String [] aikonMenuDosen = {
        "/image/dikti/Kota64.png",
        "/image/dikti/Kopertis64.png",
        "/image/dikti/Kementrian64.png",
        "/image/dikti/KelompokBidangIlmu64.png",
        "/image/dikti/KategoriPenghasilan64.png",
        "/image/dikti/JenjangPendidikan64.png"
    };
    ...
    class MemilihActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {             
            ...
            if (menuYgDipilih == 1) {
                homePage.panelBerikutnya("Kota");
            }
            if (menuYgDipilih == 2) {
                homePage.panelBerikutnya("Kopertis");
            }
            if (menuYgDipilih == 3) {
                homePage.panelBerikutnya("Kementrian");
            }            
            if (menuYgDipilih == 4) {
                homePage.panelBerikutnya("KelompokBidangIlmu");
            }
            if (menuYgDipilih == 5) {
                homePage.panelBerikutnya("KategoriPenghasilan");
            }            
            if (menuYgDipilih == 6) {
                homePage.panelBerikutnya("JenjangPendidikan");
            }
        }
    }
     ...
     */
    public MenuReferensi3(HomePage _homePage) {
    ...
    private void buttonMenuPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenuPrevActionPerformed
        ...
        homePage.panelBerikutnya("Referensi2");
    ...
    private void buttonMenuNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenuNextActionPerformed
        ...
        homePage.panelBerikutnya("Referensi4");
