 ...
 * @author asus
 */
public class MenuReferensi extends javax.swing.JPanel {  
    ...
    private String [] aikonMenuDosen = {
        "/image/dikti/Wilayah64.png",
        "/image/dikti/StatusAktivitasDosen64.png",
        "/image/dikti/StatusAktivitasMahasiswa64.png",
        "/image/dikti/Seksi64.png",
        "/image/dikti/PeranPengguna64.png",
        "/image/dikti/Pulau64.png"
    };
    ...
    class MemilihActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {             
            ...
            if (menuYgDipilih == 1) {
                homePage.panelBerikutnya("Wilayah");
            }
            if (menuYgDipilih == 2) {
                homePage.panelBerikutnya("StatusAktivitasDosen");
            }
            if (menuYgDipilih == 3) {
                homePage.panelBerikutnya("StatusMahasiswa");
            }            
            if (menuYgDipilih == 4) {
                homePage.panelBerikutnya("Seksi");
            }
            if (menuYgDipilih == 5) {
                homePage.panelBerikutnya("PeranPengguna");
            }
            if (menuYgDipilih == 6) {
                homePage.panelBerikutnya("Pulau");
            }            
        }
    }
     ...
     */
    public MenuReferensi(HomePage _homePage) {
