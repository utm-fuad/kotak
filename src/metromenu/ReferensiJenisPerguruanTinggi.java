 ...
 * @author asus
 */
public class ReferensiJenisPerguruanTinggi extends javax.swing.JPanel {
     ...
     */
    public ReferensiJenisPerguruanTinggi() {    
        initComponents();
    }
    
    public ReferensiJenisPerguruanTinggi(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_JENIS_PERGURUAN_TINGGI";
    ...
    public ReferensiJenisPerguruanTinggi(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        kodejenisperguruantinggiField.setText("");
        namajenisperguruantinggiField.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        
        kodejenisperguruantinggiField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodejenisperguruantinggiField.setText(tabel.getValueAt(row, 0).toString());        
        namajenisperguruantinggiField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodejenisperguruantinggiField.getText().equals("")?kodejenisperguruantinggiField.getText():"X");
        data[1] = (!namajenisperguruantinggiField.getText().equals("")?namajenisperguruantinggiField.getText():"X");        
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namajenisperguruantinggiField.getText();                
        ...
        data[3] = "" + idlogaudit;
        data[4] = kodejenisperguruantinggiField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodejenisperguruantinggiField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodejenisptLabel = new javax.swing.JLabel();
        namajenisptLabel = new javax.swing.JLabel();
        ...
        kodejenisperguruantinggiField = new javax.swing.JTextField();
        namajenisperguruantinggiField = new javax.swing.JTextField();
        ...
        kodejenisptLabel.setText("Kode Jenis Perguruan Tinggi:");
        panelLabel.add(kodejenisptLabel);

        namajenisptLabel.setText("Nama Jenis Perguruan Tinggi:");
        panelLabel.add(namajenisptLabel);
        ...
        panelTextField.add(kodejenisperguruantinggiField);
        panelTextField.add(namajenisperguruantinggiField);
    ...
    private javax.swing.JTextField kodejenisperguruantinggiField;
    private javax.swing.JLabel kodejenisptLabel;
    private javax.swing.JTextField namajenisperguruantinggiField;
    private javax.swing.JLabel namajenisptLabel;
