 ...
 * @author asus
 */
public class ReferensiKota extends javax.swing.JPanel {
     ...
     */
    public ReferensiKota() {    
        initComponents();
    }
    
    public ReferensiKota(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void inisialisasiData() {
        ...
        query = "select * from " + namaTabel + " order by Kode_kota desc ";
    ...
    public ReferensiKota(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_kota " +
                " from TREF_KOTA " +
                " order by Kode_kota desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodekota = Integer.parseInt(data[0][0]);
        kodekota++;
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodekotaField.setText("" + kodekota);
        namakabupatenField.setText("");
        kodeprovinsi.setText("");
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("" + idlogaudit);
        
        //kodekotaField.requestFocus();
        namakabupatenField.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodekotaField.setText(tabel.getValueAt(row, 0).toString());
        namakabupatenField.setText(tabel.getValueAt(row, 1).toString());
        kodeprovinsi.setText(tabel.getValueAt(row, 2).toString());        
    ...
    private String [] dapatkanNilaiUntukInsertKeLogAudit(String _aksi, 
        ...
        jam = kalendar.get(Calendar.HOUR_OF_DAY);
        menit = kalendar.get(Calendar.MINUTE);
        detik = kalendar.get(Calendar.SECOND);
        String data5 = hari + " " + bulan + " " + tahun;
        data[5] = data5;
        System.out.println("waktu: " + data[5]);*/
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodekotaField.getText().equals("")?kodekotaField.getText():"0");
        data[1] = (!namakabupatenField.getText().equals("")?namakabupatenField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namakabupatenField.getText();                
        data[1] = kodeprovinsi.getText();
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodekotaField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodekotaField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namakabupatenLabel = new javax.swing.JLabel();
        ...
        kodekotaField = new javax.swing.JFormattedTextField();
        namakabupatenField = new javax.swing.JTextField();
        ...
        namakabupatenLabel.setText("Nama Kabupaten:");
        panelLabel.add(namakabupatenLabel);
        ...
        kodekotaField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodekotaField);
        panelTextField.add(namakabupatenField);
    ...
    private void buttonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonInsertActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();//selasa,1jan2012@krembangan2:27, dipindah ke sini kamis17jan2013
        ...
        if (hasil == 1) {
            kueri = query; //utk keperluan insert log_audit
            query = "select * from " + namaTabel + " order by Kode_kota desc ";
            kon.selectData(query);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();//selasa,1jan2012@krembangan2:27
    ...
    private javax.swing.JFormattedTextField kodekotaField;
    ...
    private javax.swing.JTextField namakabupatenField;
    private javax.swing.JLabel namakabupatenLabel;
