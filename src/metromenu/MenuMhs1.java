 ...
 * @author asus
 */
public class MenuMhs1 extends javax.swing.JPanel {  
    ...
    private String [] aikonMenuDosen = {
        "/image/mahasiswa/MasterMahasiswa64.png",
        "/image/mahasiswa/KuliahMahasiswa64.png",
        "/image/mahasiswa/NilaiSemesterMahasiswa64.png",
        "/image/mahasiswa/PindahanMahasiswaAsing64.png",
        "/image/mahasiswa/PrestasiMahasiswa64.png",
        "/image/mahasiswa/RiwayatBeasiswa64.png"        
    };
    ...
    class MemilihActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {             
            ...
            if (menuYgDipilih == 1) {
                homePage.panelBerikutnya("MasterMahasiswa");
            }
            if (menuYgDipilih == 2) {
                homePage.panelBerikutnya("KuliahMahasiswa");
            }
            if (menuYgDipilih == 3) {
                homePage.panelBerikutnya("NilaiSemesterMahasiswa");
            }
            if (menuYgDipilih == 4) {
                homePage.panelBerikutnya("PindahanMahasiswaAsing");
            }
            if (menuYgDipilih == 5) {
                homePage.panelBerikutnya("PrestasiMahasiswa");
            }
            if (menuYgDipilih == 6) {
                homePage.panelBerikutnya("RiwayatBeasiswa");
            }
        }
    }
     ...
     */
    public MenuMhs1(HomePage _homePage) {
