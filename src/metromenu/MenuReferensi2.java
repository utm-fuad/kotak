 ...
 * @author asus
 */
public class MenuReferensi2 extends javax.swing.JPanel {  
    ...
    private String [] aikonMenuDosen = {
        "/image/dikti/Provinsi64.png",
        "/image/dikti/Penduduk64.png",
        "/image/dikti/Negara64.png",
        "/image/dikti/Modul64.png",
        "/image/dikti/Menu64.png",
        "/image/dikti/LogAudit64.png"
    };
    ...
    class MemilihActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {             
            ...
            if (menuYgDipilih == 1) {
                homePage.panelBerikutnya("Provinsi");
            }
            if (menuYgDipilih == 2) {
                homePage.panelBerikutnya("Penduduk");
            }
            if (menuYgDipilih == 3) {
                homePage.panelBerikutnya("Negara");
            }            
            if (menuYgDipilih == 4) {
                homePage.panelBerikutnya("Module");
            }
            if (menuYgDipilih == 5) {
                homePage.panelBerikutnya("Menu");
            }            
            if (menuYgDipilih == 6) {
                homePage.panelBerikutnya("LogAudit");
            }
        }
    }
     ...
     */
    public MenuReferensi2(HomePage _homePage) {
