 ...
 * @author asus
 */
public class ReferensiAgama extends javax.swing.JPanel {
    ...
    private void initAutoComplete() {   
        kompletTextFieldCombo1 = new KompletTextFieldCombo(kon, 
                kodeagamaField, kodeagama);        
        String [][] datanya1 = {{"B","Budha"},{"C","Konghucu"},{"H","Hindu"},
            {"I","Islam"},{"K","Katolik"},{"P","Protestan"},{"L","Lainnya"}
        }; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(datanya1);
        kodeagama = kompletTextFieldCombo1.dapatkanTextField();
        kodeagamaField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    ...
    public ReferensiAgama(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeagama.setText(tabel.getValueAt(row, 0).toString());
        namaagamaField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        String datakodeagamamentah = kodeagama.getText();
        System.out.println("data kodeagama mentah: " + datakodeagamamentah);
        String [] datakodeagama = datakodeagamamentah.split(" ");
        System.out.println("data kodeagama yg dipilih: " + datakodeagama[0]);
        data[0] = datakodeagama[0];
        
        data[1] = (!namaagamaField.getText().equals("")?namaagamaField.getText():"X");
        data[2] = "" + idlogaudit;
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = namaagamaField.getText();                
        data[1] = "" + idlogaudit;
        data[2] = kodeagama.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodeagama.getText();
        return data;   
    }
    ...
    private javax.swing.JComboBox kodeagamaField;
    private javax.swing.JLabel kodeagamaLabel;
    private javax.swing.JTextField namaagamaField;
    private javax.swing.JLabel namaagamaLabel;
