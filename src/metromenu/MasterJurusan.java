...
import Model.ModelMasterJurusan;
import metromini.*;
...
public class MasterJurusan extends javax.swing.JPanel {
    ...
    Model.ModelMasterJurusan model;
    ...
    private void initAutoComplete() {        
        ...
        kompletTextFieldCombo2.initDataUtkAutoComplete(datanya11);        
        statusvalidasi = kompletTextFieldCombo2.dapatkanTextField();
        statusvalidasiField = kompletTextFieldCombo2.dapatkanComboBox();
    }
    
    private void inisialisasiData() {
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from pdpt_dev.\"TMST_JURUSAN\" where \"Kode_perguruan_tinggi\"='"+kodept+"'"; //di
        kon.selectData(query);     
    ...
    public MasterJurusan(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        kodejurusanField.setText("");
        namajurusanField.setText("");
        kodefakultas.setText("");
        //kodeperguruantinggiField.setText("" + homePage.dapatkanKodePT());//ukt pdpt pt
        kodeperguruantinggiField.setText("");//utk pdpt dikti
        programstudiygdiasuhField.setText("");        
        tglawalberdiriField.setDate(null);
        noSKpenyelenggaraField.setText("");
        tglSKpenyelenggaraField.setDate(null);
        statusvalidasi.setText("");
        IDlogauditField.setText("");
        
        kodejurusanField.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        namajurusanLabel = new javax.swing.JLabel();
        kodefakultasLabel = new javax.swing.JLabel();
        kodeperguruantinggiLabel = new javax.swing.JLabel();
        programstudiygdiasuhLabel = new javax.swing.JLabel();
        tglawalberdiriLabel = new javax.swing.JLabel();
        noSKpenyelenggaraLabel = new javax.swing.JLabel();
        tglSKpenyelenggaraLabel = new javax.swing.JLabel();
        statusvalidasiLabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        kodejurusanField = new javax.swing.JFormattedTextField();
        namajurusanField = new javax.swing.JTextField();
        kodefakultasField = new javax.swing.JComboBox();
        kodeperguruantinggiField = new javax.swing.JFormattedTextField();
        programstudiygdiasuhField = new javax.swing.JTextField();
        tglawalberdiriField = new com.toedter.calendar.JDateChooser();
        noSKpenyelenggaraField = new javax.swing.JTextField();
        tglSKpenyelenggaraField = new com.toedter.calendar.JDateChooser();
        ...
        namajurusanLabel.setText("Nama Jurusan:");
        panelLabel.add(namajurusanLabel);
        ...
        programstudiygdiasuhLabel.setText("Program Studi yg Diasuh:");
        panelLabel.add(programstudiygdiasuhLabel);

        tglawalberdiriLabel.setText("Tgl Awal Berdiri:");
        panelLabel.add(tglawalberdiriLabel);

        noSKpenyelenggaraLabel.setText("No SK Penyelenggara:");
        panelLabel.add(noSKpenyelenggaraLabel);

        tglSKpenyelenggaraLabel.setText("Tgl SK Penyelenggara:");
        panelLabel.add(tglSKpenyelenggaraLabel);
        ...
        kodejurusanField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#####"))));
        panelTextField.add(kodejurusanField);
        panelTextField.add(namajurusanField);
        ...
        panelTextField.add(programstudiygdiasuhField);
        panelTextField.add(tglawalberdiriField);
        panelTextField.add(noSKpenyelenggaraField);
        panelTextField.add(tglSKpenyelenggaraField);
    ...
    private void tampilkanData(int row) {
        ...
        kodejurusanField.setText(tabel.getValueAt(row, 0).toString());
        namajurusanField.setText(tabel.getValueAt(row, 1).toString());
        kodefakultas.setText(tabel.getValueAt(row, 2).toString());
        kodeperguruantinggiField.setText(tabel.getValueAt(row, 3).toString());
        programstudiygdiasuhField.setText(tabel.getValueAt(row, 4).toString());
        ...
        noSKpenyelenggaraField.setText(tabel.getValueAt(row, 6).toString());
        
        strKalendar = tabel.getValueAt(row, 7).toString();
        System.out.println("kalendar: " + strKalendar);
        System.out.println("tahun: " + strKalendar.substring(0, 4));
        System.out.println("bulan: " + strKalendar.substring(5, 7));
        System.out.println("hari: " + strKalendar.substring(8, 10));
        ...
        kalendar = Calendar.getInstance();
        kalendar.set(tahun, intBulan - 1, hari); 
        tglSKpenyelenggaraField.setCalendar(kalendar);
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = kodejurusanField.getText();
        data[1] = namajurusanField.getText();
        ...
        data[4] = programstudiygdiasuhField.getText();
        ...
        data[5] = (data8!=null?data8:"");
        data[6] = noSKpenyelenggaraField.getText();
        kalendar = tglSKpenyelenggaraField.getCalendar();
        if (kalendar==null) {kalendar = Calendar.getInstance();}
        hari = kalendar.get(Calendar.DAY_OF_MONTH);
        bulan = namaBulan[kalendar.get(Calendar.MONTH)];
        tahun = kalendar.get(Calendar.YEAR);        
        String data9 = tahun + "-" + kalendar.get(Calendar.MONTH) + "-" + hari;
        data[7] = (data9!=null?data9:"");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                
        data[0] = namajurusanField.getText();
        data[1] = programstudiygdiasuhField.getText();
        kalendar = tglawalberdiriField.getCalendar();
        hari = kalendar.get(Calendar.DAY_OF_MONTH);
        bulan = namaBulan[kalendar.get(Calendar.MONTH)];
        tahun = kalendar.get(Calendar.YEAR);
        ...
        data[2] = data7;
        data[3] = noSKpenyelenggaraField.getText();
        kalendar = tglSKpenyelenggaraField.getCalendar();
        hari = kalendar.get(Calendar.DAY_OF_MONTH);
        bulan = namaBulan[kalendar.get(Calendar.MONTH)];
        tahun = kalendar.get(Calendar.YEAR);
        ...
        String [] datastatusvalidasi = datastatusvalidasimentah.split(" ");
        System.out.println("data status validasi yg dipilih: " + datastatusvalidasi[0]);
        data[5] = datastatusvalidasi[0];
        
        data[6] = "" + idlogaudit;
        data[7] = kodejurusanField.getText();
        
        String datakodefakultasmentah = kodefakultas.getText();
        System.out.println("data kode fakultas mentah: " + datakodefakultasmentah);
        String [] datakodefakultas = datakodefakultasmentah.split(" ");
        System.out.println("data kode fakultas yg dipilih: " + datakodefakultas[0]);
        data[8] = datakodefakultas[0];
    ...
    private void buttonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonInsertActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();
        String query = "insert into pdpt_dev.\"TMST_JURUSAN\" " +
        " values(?,?,?,?,?,?,?,?,?,?) ";
...
//            dapatkanNilaiUntukInsert() );
        int hasil = model.insertAktifitasDOsen(query,
            dapatkanNilaiUntukInsert() );
        if (hasil == 1) {
            query = "select * from pdpt_dev.\"TMST_JURUSAN\" ";
            kon.selectData(query);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();
        String query = "update pdpt_dev.\"TMST_JURUSAN\" " +
        " SET \"Nama_jurusan\"=?, " +
        "\"Program_studi_yg_diasuh\"=?, " +
        "\"Tgl_awal_berdiri\"=?, " +
        "\"No_SK_penyelenggara\"=?, " +
        "\"Tgl_SK_penyelenggara\"=?, " +
        "\"Status_validasi\"=?, " +
        "\"ID_log_audit\"=? " +
        " WHERE \"Kode_jurusan\"=? AND " + 
        "\"Kode_fakultas\"=? AND " +
...
//            dapatkanNilaiUntukUpdate() );
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        // TODO add your handling code here:
        initIDLogAudit();
        String query = "delete from pdpt_dev.\"TMST_JURUSAN\" WHERE " +
        " \"Kode_jurusan\"=? AND " +
        " \"Kode_fakultas\"=? AND " +
        " \"Kode_perguruan_tinggi\"=? ";
    ...
    private javax.swing.JFormattedTextField kodejurusanField;
    ...
    private javax.swing.JTextField namajurusanField;
    private javax.swing.JLabel namajurusanLabel;
    private javax.swing.JTextField noSKpenyelenggaraField;
    private javax.swing.JLabel noSKpenyelenggaraLabel;
    ...
    private javax.swing.JTextField programstudiygdiasuhField;
    private javax.swing.JLabel programstudiygdiasuhLabel;
    private javax.swing.JComboBox statusvalidasiField;
    private javax.swing.JLabel statusvalidasiLabel;
    private javax.swing.JTable tabel;
    private com.toedter.calendar.JDateChooser tglSKpenyelenggaraField;
    private javax.swing.JLabel tglSKpenyelenggaraLabel;
