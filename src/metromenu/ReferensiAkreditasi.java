 ...
 * @author asus
 */
public class ReferensiAkreditasi extends javax.swing.JPanel {
    ...
    private int kodeakreditasi, idlogaudit;
    private String kueri;
    
    private JTextField statusakreditasi;  
    private koneksi.KompletTextFieldCombo kompletTextFieldCombo1;    

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiAkreditasi() {    
        initComponents();
    }
    
    public ReferensiAkreditasi(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void inisialisasiData() {
        namaTabel = "TREF_AKREDITASI";
        kon = homePage.dapatkanKoneksiDB();
        query = "select * from " + namaTabel + " order by Kode_akreditasi desc";
    ...
    private void initAutoComplete() {   
        kompletTextFieldCombo1 = new KompletTextFieldCombo(kon, 
                statusakreditasiField, statusakreditasi);        
        String [][] datanya1 = {{"A","Berakreditasi A"},
            {"B","Berakreditasi B"},{"C","Berakreditasi C"},
            {"D","Berakreditasi D"},{"U","Unggul"},{"L","Belajar"}
        }; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(datanya1);
        statusakreditasi = kompletTextFieldCombo1.dapatkanTextField();
        statusakreditasiField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    
    private void initPKAutoIncrement() {
        query = "select Kode_akreditasi " +
                " from TREF_AKREDITASI " +
                " order by Kode_akreditasi desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodeakreditasi = Integer.parseInt(data[0][0]);
        kodeakreditasi++;
        System.out.println("KodeAkreditasi: " + kodeakreditasi);
    }
    ...
    public ReferensiAkreditasi(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodeakreditasiField.setText("" + kodeakreditasi);
        statusakreditasi.setText("");
        keteranganakreditasiField.setText("");        
        tglmulaiefektifField.setDate(null);
        tglakhirefektifField.setDate(null);
        IDlogauditField.setText("");
        
        statusakreditasi.requestFocus();
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodeakreditasiField.setText(tabel.getValueAt(row, 0).toString());
        statusakreditasi.setText(tabel.getValueAt(row, 1).toString());       
        keteranganakreditasiField.setText(tabel.getValueAt(row, 2).toString());
         
        
        String strKalendar = tabel.getValueAt(row, 3).toString();
        ...
        strKalendar = tabel.getValueAt(row, 4).toString();
        System.out.println("kalendar: " + strKalendar);
        System.out.println("tahun: " + strKalendar.substring(0, 4));
        System.out.println("bulan: " + strKalendar.substring(5, 7));
        System.out.println("hari: " + strKalendar.substring(8, 10));
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeakreditasiField.getText().equals("")?kodeakreditasiField.getText():"X");
                
        String datastatusakreditasimentah = statusakreditasi.getText();
        System.out.println("data statusakreditasi mentah: " + datastatusakreditasimentah);
        String [] datastatusakreditasi = datastatusakreditasimentah.split(" ");
        System.out.println("data statusakreditasi yg dipilih: " + datastatusakreditasi[0]);
        data[1] = datastatusakreditasi[0];
        
        data[2] = (!keteranganakreditasiField.getText().equals("")?keteranganakreditasiField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = statusakreditasi.getText();
        data[1] = keteranganakreditasiField.getText();                
        ...
        data[4] = "" + idlogaudit;
        data[5] = kodeakreditasiField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodeakreditasiField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        statusakreditasiLabel = new javax.swing.JLabel();
        keteranganakreditasiLabel = new javax.swing.JLabel();
        ...
        kodeakreditasiField = new javax.swing.JFormattedTextField();
        statusakreditasiField = new javax.swing.JComboBox();
        keteranganakreditasiField = new javax.swing.JTextField();
        ...
        statusakreditasiLabel.setText("Status Akreditasi");
        panelLabel.add(statusakreditasiLabel);

        keteranganakreditasiLabel.setText("Keterangan Akreditasi:");
        panelLabel.add(keteranganakreditasiLabel);
        ...
        kodeakreditasiField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodeakreditasiField);

        panelTextField.add(statusakreditasiField);
        panelTextField.add(keteranganakreditasiField);
    ...
    private void buttonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUpdateActionPerformed
        ...
        " SET Status_akreditasi=?, " +
        "Keterangan_akreditasi=?, " +        
        "Tgl_mulai_efektif=?, " +
        "Tgl_akhir_efektif=?, " +
        "ID_log_audit=? " +
        " WHERE Kode_akreditasi=? ";
        int hasil = kon.insertUpdateDeleteData(query,
    ...
    private javax.swing.JTextField keteranganakreditasiField;
    private javax.swing.JLabel keteranganakreditasiLabel;
    private javax.swing.JFormattedTextField kodeakreditasiField;
    ...
    private javax.swing.JComboBox statusakreditasiField;
    private javax.swing.JLabel statusakreditasiLabel;
