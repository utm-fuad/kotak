 ...
 * @author asus
 */
public class ReferensiModule extends javax.swing.JPanel {
    ...
    private int kodemodule, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiModule() {    
        initComponents();
    }
    
    public ReferensiModule(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_module " +
                " from TREF_MODULE " +
                " order by Kode_module desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodemodule = Integer.parseInt(data[0][0]);
        kodemodule++;
        System.out.println("kodemodule: " + kodemodule);
    }
    ...
    public ReferensiModule(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodemoduleField.setText(tabel.getValueAt(row, 0).toString());
        namamoduleField.setText(tabel.getValueAt(row, 1).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodemoduleField.getText().equals("")?kodemoduleField.getText():"0");
        data[1] = (!namamoduleField.getText().equals("")?namamoduleField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                        
        data[0] = (!namamoduleField.getText().equals("")?namamoduleField.getText():"X");
        ...
        data[4] = "" + idlogaudit;
        data[5] = (!kodemoduleField.getText().equals("")?kodemoduleField.getText():"0");
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodemoduleField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodemoduleLabel = new javax.swing.JLabel();
        namamoduleLabel = new javax.swing.JLabel();
        ...
        kodemoduleField = new javax.swing.JFormattedTextField();
        namamoduleField = new javax.swing.JTextField();
        ...
        kodemoduleLabel.setText("Kode Module:");
        panelLabel.add(kodemoduleLabel);

        namamoduleLabel.setText("Nama Module:");
        panelLabel.add(namamoduleLabel);
        ...
        kodemoduleField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodemoduleField);
        panelTextField.add(namamoduleField);
    ...
    private javax.swing.JFormattedTextField kodemoduleField;
    private javax.swing.JLabel kodemoduleLabel;
    private javax.swing.JTextField namamoduleField;
    private javax.swing.JLabel namamoduleLabel;
