...
import Model.ModelTransaksiRiwayatAkreditasiProdi;
import metromini.*;
 ...
 * @author asus
 */
public class RiwayatAkreditasiProdi extends javax.swing.JPanel {
    ...
    Model.ModelTransaksiRiwayatAkreditasiProdi model;
     ...
     */
    public RiwayatAkreditasiProdi() {    
        initComponents();
    }
    
    public RiwayatAkreditasiProdi(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model = new ModelTransaksiRiwayatAkreditasiProdi();
        IDlogauditLabel.setVisible(false);
        IDlogauditField.setVisible(false);
        koderiwayatakreditasiprodiField.setVisible(false);
        koderiwayatakreditasiprodiLabel.setVisible(false);
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_RIWAYAT_AKREDITASI_PRODI\"";
        kon = homePage.dapatkanKoneksiDB();
        query = "select \"Tahun_pelaporan\",\"Semester_pelaporan\",\"Kode_program_studi\","
                + "\"Kode_perguruan_tinggi\",\"Kode_akreditasi\",\"No_SK_BAN\","
                + "\"tgl_SK_BAN\" from " + namaTabel+" where \"Kode_perguruan_tinggi\"='"+kodept+"'"; 
        kon.selectData(query);     
    ...
    public RiwayatAkreditasiProdi(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        koderiwayatakreditasiprodiField.setText("");
        ...
        kodeakreditasiField.setText("");
        noSKBANField.setText("");
        tglSKBANField.setDate(null);        
        IDlogauditField.setText("");
        
        koderiwayatakreditasiprodiField.requestFocus();
    }
...
//        koderiwayatakreditasiprodiField.setText(tabel.getValueAt(row, 0).toString());
        ...
        kodeakreditasiField.setText(tabel.getValueAt(row, 4).toString());
        noSKBANField.setText(tabel.getValueAt(row, 5).toString());
...
//        data[0] = (!koderiwayatakreditasiprodiField.getText().equals("")?koderiwayatakreditasiprodiField.getText():"0");
        ...
        data[4] = (!kodeakreditasiField.getText().equals("")?kodeakreditasiField.getText():"0");
        
        data[5] = (!noSKBANField.getText().equals("")?noSKBANField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[0] = (!kodeakreditasiField.getText().equals("")?kodeakreditasiField.getText():"0");
        
        data[1] = (!noSKBANField.getText().equals("")?noSKBANField.getText():"X");
    ...
    private void initComponents() {
        ...
        koderiwayatakreditasiprodiLabel = new javax.swing.JLabel();
        ...
        koderiwayatakreditasiprodiField = new javax.swing.JFormattedTextField();
        ...
        kodeakreditasiField = new javax.swing.JTextField();
        ...
        koderiwayatakreditasiprodiLabel.setText("Kode Riwayat Akreditasi Prodi:");
        panelLabel.add(koderiwayatakreditasiprodiLabel);
        ...
        noSKBANLabel.setText("No SK BAN:");
        ...
        koderiwayatakreditasiprodiField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat(""))));
        panelTextField.add(koderiwayatakreditasiprodiField);
...
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JTextField kodeakreditasiField;
    ...
    private javax.swing.JFormattedTextField koderiwayatakreditasiprodiField;
    private javax.swing.JLabel koderiwayatakreditasiprodiLabel;
