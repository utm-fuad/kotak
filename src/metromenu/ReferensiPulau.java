 ...
 * @author asus
 */
public class ReferensiPulau extends javax.swing.JPanel {
    ...
    private int kodepulau, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiPulau() {    
        initComponents();
    }
    
    public ReferensiPulau(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initPKAutoIncrement() {
        query = "select Kode_pulau " +
                " from TREF_PULAU " +
                " order by Kode_pulau desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodepulau = Integer.parseInt(data[0][0]);
        kodepulau++;
        System.out.println("kodepulau: " + kodepulau);
    }
    ...
    public ReferensiPulau(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodepulauField.setText(tabel.getValueAt(row, 0).toString());
        namapulauField.setText(tabel.getValueAt(row, 1).toString());        
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodepulauField.getText().equals("")?kodepulauField.getText():"0");        
        data[1] = (!namapulauField.getText().equals("")?namapulauField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        data[3] = "" + idlogaudit;
        data[4] = kodepulauField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodepulauField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namapulauLabel = new javax.swing.JLabel();
        ...
        kodepulauField = new javax.swing.JFormattedTextField();
        namapulauField = new javax.swing.JTextField();
        ...
        namapulauLabel.setText("Nama Pulau:");
        panelLabel.add(namapulauLabel);
        ...
        kodepulauField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodepulauField);
        panelTextField.add(namapulauField);
    ...
    private javax.swing.JFormattedTextField kodepulauField;
    private javax.swing.JLabel kodepulauLabel;
    private javax.swing.JTextField namapulauField;
    private javax.swing.JLabel namapulauLabel;
