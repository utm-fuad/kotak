 ...
 * @author asus
 */
public class FTEDosen extends javax.swing.JPanel {
    ...
    Model.ModelFTEDosen model;
    private JTextField jenisfte;  
    ...
    private int kodeftedosen, idlogaudit;
    ...
    public FTEDosen(HomePage _homePage, String _namaTabel) {
        this();
        this.homePage = _homePage;
        this.namaTabel = _namaTabel;
        model =new ModelFTEDosen();
        ...
        IDlogauditField.setVisible(false);
        IDlogauditLabel.setVisible(false);
        IDlogauditLabel1.setVisible(true);
        UUIDField.setVisible(false);
    }
    
    private void initPKAutoIncrement() {
        query = "select \"Kode_FTE_dosen\" " +
                " from pdpt_dev.\"TRAN_FTE_DOSEN\" " +
                " order by \"Kode_FTE_dosen\" desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodeftedosen = Integer.parseInt(data[0][0]);
        kodeftedosen++;
        System.out.println("kodeftedosen: " + kodeftedosen);
    }
    ...
    private void initAutoComplete() {
        kompletTextFieldCombo1 = new KompletTextFieldCombo(kon, 
                jenisFTEField, jenisfte);        
        String [][] datanya1 = {{"1", "Aktivitas Mengajar"},
            {"2", "Penelitian/Publikasi"},{"3", "Jabatan Struktural"}}; 
        kompletTextFieldCombo1.initDataUtkAutoComplete(datanya1);
        jenisfte = kompletTextFieldCombo1.dapatkanTextField();
        jenisFTEField = kompletTextFieldCombo1.dapatkanComboBox();
    ...
    private void inisialisasiData() {
        namaTabel = "pdpt_dev.\"TRAN_FTE_DOSEN\"";
    ...
    public FTEDosen(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void persiapanEntriDataBaru() {
        initPKAutoIncrement();
        kodeFTEdosenField.setText("" + kodeftedosen);
        tahunpelaporanField.setText("");
        semesterpelaporanField.setText("");
        nidnnuk.setText("");
        jenisfte.setText("");
        jumlahFTEField.setText("");
    ...
    private void tampilkanData(int row) {
        ...
        kodeFTEdosenField.setText(tabel.getValueAt(row, 0).toString());
        ...
        jenisfte.setText(tabel.getValueAt(row, 4).toString());        
        jumlahFTEField.setText(tabel.getValueAt(row, 5).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodeFTEdosenField.getText().equals("")?kodeFTEdosenField.getText():"0");
        ...
        data[3] = datanidnnuk[0];
        
        String datajenisftementah = jenisfte.getText();
        System.out.println("data jenisfte mentah: " + datajenisftementah);
        String [] datajenisfte = datajenisftementah.split(" ");
        System.out.println("data jenisfte yg dipilih: " + datajenisfte[0]);
        data[4] = datajenisfte[0];
        
        data[5] = (!jumlahFTEField.getText().equals("")?jumlahFTEField.getText():"0");
        data[6] = "" + idlogaudit;
        data[7] = homePage.dapatkanKodePT()+nidnnuk.getText().charAt(0)+nidnnuk.getText().charAt(1)+nidnnuk.getText().charAt(2);
        return data;
    }
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        ...
        String [] datajenisfte = datajenisftementah.split(" ");
        System.out.println("data jenisfte yg dipilih: " + datajenisfte[0]);
        data[3] = datajenisfte[0];
        
        data[4] = jumlahFTEField.getText();
        data[5] = "" + idlogaudit;
        data[6] = homePage.dapatkanKodePT()+nidnnuk.getText().charAt(0)+nidnnuk.getText().charAt(1)+nidnnuk.getText().charAt(2);
        data[7] = kodeFTEdosenField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodeFTEdosenField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        kodeFTEdosenLabel = new javax.swing.JLabel();
        ...
        jenisFTELabel = new javax.swing.JLabel();
        jumlahFTELabel = new javax.swing.JLabel();
        IDlogauditLabel = new javax.swing.JLabel();
        IDlogauditLabel1 = new javax.swing.JLabel();
        panelTextField = new javax.swing.JPanel();
        kodeFTEdosenField = new javax.swing.JFormattedTextField();
        ...
        jenisFTEField = new javax.swing.JComboBox();
        jumlahFTEField = new javax.swing.JFormattedTextField();
        ...
        kodeFTEdosenLabel.setText("Kode FTE Dosen:");
        panelLabel.add(kodeFTEdosenLabel);
        ...
        jenisFTELabel.setText("Jenis FTE:");
        panelLabel.add(jenisFTELabel);

        jumlahFTELabel.setText("Jumlah FTE:");
        panelLabel.add(jumlahFTELabel);
        ...
        kodeFTEdosenField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodeFTEdosenField);
        ...
        panelTextField.add(jenisFTEField);

        jumlahFTEField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(jumlahFTEField);
...
//            dapatkanNilaiUntukUpdate() );
    ...
    private javax.swing.JComboBox jenisFTEField;
    private javax.swing.JLabel jenisFTELabel;
    private javax.swing.JFormattedTextField jumlahFTEField;
    private javax.swing.JLabel jumlahFTELabel;
    private javax.swing.JFormattedTextField kodeFTEdosenField;
    private javax.swing.JLabel kodeFTEdosenLabel;
