 ...
 * @author asus
 */
public class MenuLembaga3 extends javax.swing.JPanel {  
    ...
    private String [] aikonMenuDosen = {
        "/image/lembaga/MasterPT64.png",
        "/image/lembaga/MasterPustaka64.png",
        "/image/lembaga/MasterSaranaPT64.png",
        "/image/lembaga/MasterLaboratorium64.png",
        "/image/lembaga/MasterFasilitasPenunjangAkademik64.png",
        "/image/lembaga/MasterKerjasamaPTLuarNegeri64.png"
    };
    ...
    class MemilihActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {             
            ...
            if (menuYgDipilih == 1) {
                homePage.panelBerikutnya("MasterPT");
            }
            if (menuYgDipilih == 2) {
                homePage.panelBerikutnya("MasterPustaka");
            }
            if (menuYgDipilih == 3) {
                homePage.panelBerikutnya("MasterSaranaPT");
            }
            if (menuYgDipilih == 4) {
                homePage.panelBerikutnya("MasterLaboratorium");
            }
            if (menuYgDipilih == 5) {
                homePage.panelBerikutnya("MasterFasilitasPenunjangAkademik");
            }
            if (menuYgDipilih == 6) {
                homePage.panelBerikutnya("MasterKerjasamaPTLuarNegeri");
            }
        }
    }
     ...
     */
    public MenuLembaga3(HomePage _homePage) {
    ...
    private void buttonMenuPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenuPrevActionPerformed
        ...
        homePage.panelBerikutnya("Lembaga2");
    ...
    private void buttonMenuNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMenuNextActionPerformed
        ...
        homePage.panelBerikutnya("Lembaga4");
