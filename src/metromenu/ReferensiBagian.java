 ...
 * @author asus
 */
public class ReferensiBagian extends javax.swing.JPanel {
    ...
    private int kodebagian, idlogaudit;
    private String kueri;

    /**
     * Creates new form PanelHalaman1
     */
    public ReferensiBagian() {    
        initComponents();
    }
    
    public ReferensiBagian(HomePage _homePage, String _namaTabel) {
        this();
    ...
    private void initIDLogAudit() {
        query = "select Kode_bagian " +
                " from TREF_BAGIAN " +
                " order by Kode_bagian desc";
        kon.selectData(query);     
        String [][] data = kon.dapatkanData();
        kodebagian = Integer.parseInt(data[0][0]);
        kodebagian++;
        System.out.println("KodeKopertis: " + kodebagian);
    ...
    private void initAutoComplete() {        
        ...
        kodedirektorat = kompletTextFieldCombo1.dapatkanTextField();
        kodedirektoratField = kompletTextFieldCombo1.dapatkanComboBox();
    }
    ...
    public ReferensiBagian(String [][] data, String [] kolom) {
        this();
        tampilkanDataKeTabel(data, kolom);
    }
    ...
    private void tampilkanData(int row) {
        ...
        kodebagianField.setText(tabel.getValueAt(row, 0).toString());        
        kodedirektorat.setText(tabel.getValueAt(row, 1).toString());        
        namabagianField.setText(tabel.getValueAt(row, 2).toString());
    ...
    public String [] dapatkanNilaiUntukInsert() {
        ...
        data[0] = (!kodebagianField.getText().equals("")?kodebagianField.getText():"0");
        ...
        data[1] = datakodedirektorat[0];
        
        data[2] = (!namabagianField.getText().equals("")?namabagianField.getText():"X");
    ...
    public String[] dapatkanNilaiUntukUpdate(){
        String [] data = new String[jmlKolom];                                
        data[0] = kodedirektorat.getText();                
        data[1] = namabagianField.getText();                
        ...
        data[5] = "" + idlogaudit;
        data[6] = kodebagianField.getText();
        return data;
    }
    
    public String[] dapatkanNilaiUntukDelete(){
        String [] data = new String[1];
        data[0] = kodebagianField.getText();
        return data;   
    }
    ...
    private void initComponents() {
        ...
        namabagianLabel = new javax.swing.JLabel();
        ...
        kodebagianField = new javax.swing.JFormattedTextField();
        kodedirektoratField = new javax.swing.JComboBox();
        namabagianField = new javax.swing.JTextField();
        ...
        namabagianLabel.setText("Nama Bagian:");
        panelLabel.add(namabagianLabel);
        ...
        kodebagianField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#"))));
        panelTextField.add(kodebagianField);

        panelTextField.add(kodedirektoratField);
        panelTextField.add(namabagianField);
    ...
    private javax.swing.JFormattedTextField kodebagianField;
    ...
    private javax.swing.JTextField namabagianField;
    private javax.swing.JLabel namabagianLabel;
